...
class surveytrackermodel extends Database {
    ...
    public function getSurvey() {
        ...
        $query = 'SELECT id, country, full_name, filename, filetype, category, subcategory, date_created from survey ORDER BY date_created desc';
        $data = $this->selectDBraw($query);
    ...
    public function getWord() {
        ...
        $filetype = 'MS-WORD';
        $query = 'SELECT id, full_name, filename, filetype, category, subcategory, date_created  from survey WHERE filetype="'.$filetype.'"  ORDER BY date_created desc ';
        $data = $this->selectDBraw($query);
    ...
    public function getmysurveys() {
        $email = $_SESSION["email"];
        $query = 'SELECT id, full_name, filename, filetype, category, subcategory, date_created  from survey WHERE email ="'.$email.'" ORDER BY date_created desc ';
        $data = $this->selectDBraw($query);
        return $data;
    }

    public function getcategory($category) {
        $query = $query = 'SELECT id, full_name, filename, filetype, category, subcategory, date_created  from survey WHERE filename like "%' . $category. '%" ORDER BY date_created desc';
        $data = $this->selectDBraw($query);
