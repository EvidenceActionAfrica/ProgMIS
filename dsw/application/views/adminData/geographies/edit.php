...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>adminData/update/<?php echo $table ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                ...
                <div class="col-md-offset-4">
                    ...
                    <a href='<?php echo URL . "adminData/geography/" . $table ?>'>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </a>
                    <button  type="submit" class="btn btn-primary" name="update-admin-data" id="update-admin-data">Update Details</button>
                </div>
            </form>
        </div>
    </div>
