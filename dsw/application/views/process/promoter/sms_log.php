        ...
        <div >
            ...
            <form  action="<?php echo URL; ?>processdata/smsupdate/promoter_sms_log/<?php echo $promoterId; ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                                ...
                                if ($value['Key'] == 'PRI') {
                                    ...
                                    if (!isset($single_record)) {
                                        ...
                                        echo '
                                                <div class="form-group">
                                                    <label>' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <input type="text" name="' . $value['Field'] . '" class="form-control input-sm" value="' . $waterpointId. '" readonly/>
                                                </div>
                                            ';
                ...
                <div class="col-md-offset-4">
                    ...
                    <button  type="submit" class="btn btn-primary" name="add-sms-data" id="add-sms-data">Save Details</button>
                </div>
            </form>
        </div>
    </div>
