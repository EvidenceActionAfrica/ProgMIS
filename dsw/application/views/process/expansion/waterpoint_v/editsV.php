...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>expansion/sVerificationUpdate/<?php echo $table.'/'.$edit ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                            ...
                            foreach ($fields as $key => $value) {
                               ...
                               if($value['Field'] == 'lsm_id'){
                                if (!isset($single_record)) {
                                    ...
                                    }else if (strpos($value['Field'], 'territories') !== false ) {
                                    ...
                                    if (!isset($single_record)) {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="' . $value['Field'] . '" class="form-control input-sm " style="display:none;" readonly></textarea>
                                            </div>
                                        ';
                                        } else {
                                            echo '
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="' . $value['Field'] . '" class="form-control input-sm" style="display:none;" readonly>'. $single_record[$x] . '</textarea>
                                                </div>
                                            ';
                                        }
