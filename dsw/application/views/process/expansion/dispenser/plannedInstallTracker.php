...
<div class="col-md-10">
    ...
    <h3> Installation-Cem Tracking</h3>
        <hr>
    </div>
                ...
                <tbody>
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        <tr>
                            ...
                            ?>
                                <td class="buttons" ><a href="<?php echo URL ?>expansion/dispenserInstallTrackAll/<?php echo  rawurlencode($data[$i]['program']); ?>" class="btn btn-default btn-xs" >View Data</a></td> 
