...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>scheduler/updateSchedule/<?php echo $table.'/'.$edit.'/'.$program ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                                ...
                                if (!isset($single_record)) {
                                    ...
                                    echo '
                                                <div class="form-group">
                                                    <label>' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <select ' . $disabled . ' name="' . $value['Field'] . '" class="form-control input-sm" required><option value="">Select ' . ucwords(str_replace('_', ' ', $value['Field'])) . '</option>';
                                    foreach ($villageDropDown as $key => $value_) {
                                        if ($value_['id'] == $selectedValue) {
                ...
                <div class="col-md-offset-4">
                    ...
                    <a href='<?php echo URL . "scheduler/planSchedule/".$table.'/'.$program; ?>'>
                        <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    </a>
                    <button  type="submit" class="btn btn-primary" name="update-schedule" id="update-schedule">Update Details</button>
                </div>
            </form>
        </div>
    </div>
