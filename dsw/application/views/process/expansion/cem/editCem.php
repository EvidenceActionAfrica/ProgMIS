...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>expansion/CEMUpdate/<?php echo $table.'/'.$edit ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                ...
                <div class="col-md-offset-4">
                    ...
                    <a href='<?php echo URL . "expansion/viewCem/"; ?>'>
