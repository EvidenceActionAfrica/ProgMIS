...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form  action="<?php echo URL; ?>expansion/programAdd/<?php echo $table.'/'; ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
...
<script type="text/javascript">
    ...
    function show_confirm(tables, deleteId) {
        if (confirm("Are you sure you want to delete?")) {
            location.replace('<?php echo URL ?>expansion/programDelete/' + tables + '/' + deleteId);

        } else {
            console.log('<?php echo URL ?>expansion/programDelete/' + tables + '/' + deleteId);
            return false;
        }
    }
