...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>expansion/updateBudgetDuties/<?php echo $table.'/'.$EditLsm ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                            ...
                            foreach ($fields as $key => $value) {
                               ...
                               if($value['Field'] == 'lsm_id'){
                                if (!isset($single_record)) {
                                    ...
                                    }else if($value['Field'] == 'cost'){

                                    if (isset($single_record)) {
                                            echo '
                                            <div class="form-group">
                                                <label> ' . ucwords(str_replace('_', ' ', "estimated cost")) . '</label><br>
