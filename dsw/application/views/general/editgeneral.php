...
<div id="myModal" class="col-md-6 col-md-offset-3" >
    <div >
        <div >
            ...
            <form  action="<?php echo URL; ?>generalclass/update/<?php echo $table.'/'.$edit ?>" data-async data-target="myModal" method="post" role="form" id="modal-form">
                        ...
                        <div class="col-md-12">
                          <img src="<?php echo URL; ?>public/img/loading.gif" id="imgLoading" height="40px" style="position:absolute;top:50%;left:50%;margin:0 auto; visibility: visible"/>
                            ...
                            foreach ($fields as $key => $value) {
                                // echo "<pre>";var_dump($fields);echo "</pre>";
                                 if ($value['Key'] == 'PRI' ) {
                                ...
                                } else if ($value['Field'] == 'village' && $table=='waterpoint_details') {
                                ...
                                }  else if ($value['Field'] == 'program' && $table !='waterpoint_details' && $table !='cau_programs') {
                                    // $disabled = 'style="display:none"';
                                    $disabled = 'enabled';
                                    if (isset($single_record)) {
                                        $selectedValue = $single_record[$x];
                                    ...
                                    foreach ($programDropDown as $key => $value_) {
                                        if ($value_['program'] == $selectedValue) {
                                            echo'<option  value="' . $value_['program'] . '" selected >' . $value_['program'] . '</option>';
                                        } else {
                                ...
                                }else if ($value['Field'] == 'unix_timestamp' ||$value['Field'] == 'active' ) {
                                    continue;
                                        ...
                                        ';
                                            ...
                                            echo '
                                                <div class="form-group">
                                                    <label>' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                     <select name="' . $value['Field'] . '" class="form-control input-sm" required>
                                                        <option value="'.$single_record[$x].'">'.$single_record[$x].'</option>
                                                        <option>Select A Gender</option>
                                                        <option value="Male" >Male</option>
                                                        <option value="Female">Female</option>
                                                        <option value="Unknown">Unknown</option>
                ...
                <div class="col-md-offset-4">
                    ...
                    <a href='<?php echo URL . "generalclass/general/".$table."/"; ?>'>
