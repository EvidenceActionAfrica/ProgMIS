<div class="col-md-10">
	<div class="clearfix">
		<h3 class="pull-left"><?php echo $table; ?> Inventory</h3>
		<div class="btn-group pull-right">
			...
			<div class="btn-group">
				<a href="<?php echo URL?>assetData/export/">
				...
				<tbody>
					<?php
						...
						foreach ($data as $key => $value) { 
							...
							?>
								<td><a href="<?php echo URL?>assetData/update/" ><button class="btn btn-default">Edit</button></a></td>
								<td><a onclick="show_confirm();"><button class="btn btn-danger">Delete</button></a></td>
							<?php
							echo '</tr>';
							$J++;
						}
...
<div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
	<div class="modal-dialog modal-lg">
	    <div class="modal-content">
			...
			<form action="<?php echo URL; ?>processdata/add" data-async data-target="myModal" method="post" role="form" id="modal-form">
...
<script type="text/javascript">
	...
	function show_confirm(inventory_type_id,deleteId) {

		if (confirm("Are you sure you want to delete?")) {
			location.replace('<?php echo URL?>assetData/delete/' + inventory_type_id+'/'+deleteId);
		          
		} else {
			console.log('<?php echo URL?>assetData/delete/' + inventory_type_id+'/'+deleteId);
		 return false;
		}
	}
