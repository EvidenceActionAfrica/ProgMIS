            ...
            <table id="data-table" class="table table-striped table-hover">
                ...
                <tbody>
                    ...
                    foreach ($data as $key => $value) {
                        ...
                        if ($table == 'issues') {
                            ?>
                        <td><a href="../issuetracker/issuesaction/<?php echo $issueId; ?>"><button class="btn btn-success">Action</button></a></td>
                        <td><button  data-toggle="modal" data-target="#mySmsModal"class="btn btn-info">Send Sms</button></td>
                        <td><button  data-toggle="modal" data-target="#myEmailModal" class="btn btn-warning">Send Email</button></td>
                       <td><a href="../issuetracker/edittracker/<?php echo $issueId; ?>"><button class="btn btn-success">Edit</button></a></td> 
                       <td><a onclick="show_confirm(<?php echo $issueId; ?>);"><button class="btn btn-danger">Delete</button></a></td>    							
                    <?php
                    }
                    echo '</tr>';
                }
