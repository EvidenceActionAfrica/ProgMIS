                            ...
                            <div class="col-lg-6 col-md-1 col-sm-1 col-xs-12">
                                <div class="header-top-menu tabl-d-n">
                                    <ul class="nav navbar-nav mai-top-nav">
                                        <li class="nav-item"><a href="52.58.189.131/PROGMIS/dsw/home" class="nav-link">Home</a>
                                        </li>
                                        <li class="nav-item"><a href="52.58.189.131/PROGMIS/dsw/adminData" class="nav-link">Admin Data</a>
                                        </li>
                                        <li class="nav-item"><a href="52.58.189.131/PROGMIS/dsw/home" class="nav-link">Performance Data</a>
                                        </li>
                                        
                                        <li class="nav-item"><a href="52.58.189.131/PROGMIS/dsw/home" class="nav-link">Issue Tracker</a>
                                        </li>
