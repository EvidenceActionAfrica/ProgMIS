<?php
require_once ("../../includes/auth.php"); require_once ('../../includes/config.php'); 
							...
							<div id="rstBdy" class="rstBdy">
								<div class="inside" style="overflow: auto; margin-bottom: 20px;">
									...
									<div class="selSec">
										...
										<input id="generate_button" name="generate_repor" type="button" value="Generate Report" class="btn btn-primary" onclick="selectcounty();" />
									</div>
	...
	function selectcounty() {
		...
		$.post("func.DistrictReport.php", {
			...
			if (data==0) {
				...
				if (treatment_type == 'albe') {
					$('#report_subtitle_treatment').html(' District Albendazole Treatment Results');
					$('#report_subtitle_name').html( district_name+' District');
				} else {
					$('#report_subtitle_treatment').html( district_name + ' District Schistosomiasis Treatment Results');
					$('#report_subtitle_name').html( district_name+' District');
				}
