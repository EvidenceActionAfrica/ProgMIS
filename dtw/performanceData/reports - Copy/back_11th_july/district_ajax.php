...
$pzq_children_targeted=sumMoreFexibleByDistrict('p_pri_enroll','p_bysch','district_id',$district_id,'p_sch_bilharzia','Y');
...
$pzq_school_targeted=CountMoreFlexible('p_sch_id','p_bysch','district_id',$district_id,'p_sch_bilharzia','Y');
	...
	if ($treatment_type =='albe') {
		...
		# $children_dewormed
			...
			echo '<table border="1" cellpadding="1" cellspacing="1" width="50%" align="center">
				 <tr><td width="80%">Schools targeted</td><td width="20%">' . number_format($school_targeted) . '</td></tr>
				 <tr><td>Schools participated</td><td>' . number_format($school_participated) . '</td></tr>
				 <tr><td>Children targeted</td><td>' . number_format($children_targeted) . '</td></tr>
				 <tr><td>Children dewormed</td><td>' . number_format($children_dewormed) . '</td></tr>
				 <tr><td>Enrolled children dewormed</td><td>' . number_format($enrolled_children_dewormed) . '</td></tr>
				 <tr><td>Non-enrolled children dewormed</td><td>' . number_format($non_enrolled_children_dewormed) . '</td></tr>
		 	</table>
			<table border="1" cellpadding="1" cellspacing="1" width="50%" align="center">
				<tr><td width="80%">Children 5 and under dewormed</td><td width="20%">' . number_format($under_5) . '</td></tr>
				<tr><td>Children over 5 dewormed</td><td>' . number_format($over_5) . '</td></tr>
				<tr><td>Male children dewormed</td><td>' . number_format($male_children_dewormed) . '</td></tr>
				<tr><td>Female children dewormed</td><td>' . number_format($female_children_dewormed) . '</td></tr>
				<tr><td>Est. Dist/Div MoE personnel trained</td><td>' . number_format($moe_trained) . '</td></tr>
				<tr><td>Est. Dist/Div MoPHS personnel trained</td><td>' . number_format($mophs_trained) . '</td></tr>
			</table>';
		...
		# $pzq_school_targeted
			...
			echo '<table border="1" cellpadding="1" cellspacing="1" width="50%" align="center">
				 <tr><td width="80%">Schools targeted</td><td width="20%">' . number_format($pzq_school_targeted) . '</td></tr>
				 <tr><td>Schools participated</td><td>' . number_format($pzq_school_participated) . '</td></tr>
				 <tr><td>Children targeted</td><td>' . number_format($pzq_children_targeted) . '</td></tr>
				 <tr><td>Children dewormed</td><td>' . number_format($pzq_children_dewormed) . '</td></tr>
				 <tr><td>Enrolled children dewormed</td><td>' . number_format($pzq_enrolled_children_dewormed) . '</td></tr>
				 <tr><td>Non-enrolled children dewormed</td><td>' . number_format($pzq_non_enrolled_children_dewormed) . '</td></tr>
		 	</table>
			<table border="1" cellpadding="1" cellspacing="1" width="50%" align="center">
				<tr><td width="80%">Children 5 and under dewormed</td><td width="20%">' . number_format($pzq_under_5) . '</td></tr>
				<tr><td>Children over 5 dewormed</td><td>' . number_format($pzq_over_5) . '</td></tr>
				<tr><td>Male children dewormed</td><td>' . number_format($pzq_male_children_dewormed) . '</td></tr>
				<tr><td>Female children dewormed</td><td>' . number_format($pzq_female_children_dewormed) . '</td></tr>
				<tr><td>Est. Dist/Div MoE personnel trained</td><td>' . number_format($pzq_moe_trained) . '</td></tr>
				<tr><td>Est. Dist/Div MoPHS personnel trained</td><td>' . number_format($pzq_mophs_trained) . '</td></tr>
			</table>';
	}
...
if (isset($_POST['progress_data'])) {
	...
	if ($data == "dewormed") {
		...
		if ($treatment_type =='albe') {
			...
			$primary_percentage = $pzq_enrolled_children_dewormed / $pzq_children_targeted * 100;
