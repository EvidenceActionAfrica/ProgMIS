  ...
  <img src="sexy.jpg" width="200">
			...
			<div class="contentBody">
				...
				<div id="vzoom">
					...
					<div id="donor-form">
						...
						<select id="donor-dropdown" name="donor">
							...
							<option value="CIFF" <?php if ($_GET['donor']=='CIFF') {echo "selected"; } ?> >CIFF</option>
							<option value="END"  <?php if ($_GET['donor']=='END') {echo "selected"; } ?>>END FUND</option>
						</select>
				...
				<?php 
				 ...
				 ?>
				 <?php //if (isset($_GET['donor'])) {$districts=checkDonor(); if ($districts == 0) {echo "<div id='warning_no_data'>d
				...
				// <div>"; } } ?>
				 	 ...
				 	 <?php if (isset($_GET['donor'])) {$districts=checkDonor(); if ($districts == 0) {echo "NO DATA"; } } ?>
