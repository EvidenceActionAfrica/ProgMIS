              ...
              <div class="inside-national">
                <div id="national_report_container">
                  ...
                  <p class="section_header">
                    Programme Coverage Summary for Soil-Transmitted Helminthiases (STH) Treatment
                  </p>
                  ...
                  <div class="national_section_row_container">
                    ...
                    <div class="national_column">
                      <div class="info_container">
                        <ul>
                          <li id="sth1_info_title" style="float: left; padding-right: 5px"></li>
                    ...
                    <div class="national_column">
                      <div class="info_container">
                        <ul>
                          ...
                          <!--<span style="font-size: 1.8em;">&bull; </span>-->
                ...
                $(document).ready(function() {
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      if (+contents[0] > +contents[1]) {
                        ...
                        var clause = ' far surpassing our target of 11,000‏ schools.';
                      }
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      if (+contents[0] > +contents[1]) {
                        ...
                        var clause = ' significantly exceeding our target of 5.7 million children!';
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      var clause = 'meeting our target of 144 sub-counties';
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing our goal of 144 districts!';
                        var clause = 'meeting our target of 143 sub-counties.';
                      } else {
                        clause = clause + '.';
                      }
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      if (+contents[0] > +contents[1]) {
                        ...
                        var clause = ' far surpassing our target of 600,000‏ schools.';
                      }
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      var clause = 'out of our target of 64 sub-counties.';
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing our target of ' + contents[1] + ' districts!';
                        // clause = ' surpassing our target of 64 districts!';
                        var clause = 'surpassing our target of 64 districts!';
                      }
                      createBar('#sth5_percentage_container', '#sth5_percentage_value', contents[0], contents[0] + ' Sub-counties successfully completed the programme,', '#sth5_info_title', contents[1], clause, '#sth5_info_title_sub');
