                    ...
                    <div class="contentBody">
                        <div class="col-md-12">
                                ...
                                <form method="POST">
                                    ...
                                    if (isset($_POST["county"])) {
                                        ...
                                        echo '<a target="blank" style="margin-top:-5%;float:right;" class="btn-custom-small" href="countyReport.php?pdfView=true&county=' . $_POST["county"] . '">Export To Pdf</a>';
                                             echo '&nbsp; <a id="btn-custom-small" class="btn-custom-small" href="">Export To Excel</a>';
							...
							';
                                        ...
                                        echo "<tr>";
                                        echo "<td rowspan='2'  style='text-align:center;font-weight:bolder;whitespace:pre;'><h2>Total</h2></td>";

                                        echo "<td rowspan='2'  style='text-align:center;font-weight:bolder;whitespace:pre;'><h3><u>District Dewormed</u></h3>   

								" . $totalSTHDistricts . "(STH) " . $totalSCHDistricts . "(Schisto)
							</td>";

                                        echo "<td rowspan='2'><h3><u>Total Schools</u></h3> " . number_format($totalSCHOOLS) . "</td>";
                                        echo "<td rowspan='2' colspan='4' style='text-align:center;font-weight:bolder;whitespace:pre;'><h3><u>Children Dewormed </u></h3> 

							" . $totalSTHChildren . "(STH)    " . $totalSCHChildren . "(Schisto)
