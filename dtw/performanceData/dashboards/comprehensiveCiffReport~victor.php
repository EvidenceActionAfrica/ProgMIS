                        ...
                        <div class="dashboard_menu">
                            ...
                            <div class="dashboard_export col-md-4 col-md-offset-2">
                                ...
                                <?php if ($priv_ciff_report >= 1) { ?>
                                    <a  href="exportExcelCiffReportKpi.php" class="btn-custom-small">Export To Excel</a> 

                                    <a class="btn-custom-small" href="exportPdfCiffReport.php" target="_blank">Export To PDF</a> 
                                <?php } ?>
                            </div>
                        ...
                        <div class="content00">
                            <table id="hor-minimalist-b">
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo number_format(sumArgs('a_bysch', 'ap_trt_m', 'ap_trt_f', 'ap_ecd_f', 'ap_ecd_m')); ?></td>
                        ...
                        <div class="heading00">
                            <table id="hor-minimalist-b">
                                <tr class="highlighter_tr">
                                    ...
                                    <td class="td-left" style="width:200px"><?php echo number_format(sumArgs('a_bysch', 'a_trt_m', 'a_trt_f')); ?></td>
                        ...
                        <div class="content00">
                            <table id="hor-minimalist-b">
                                <!-- <tr>
                                    ...
                                    <td class="td-left" style="width:200px"><?php //echo number_format(EstimatedTotalSTH()) ?></td>
                                </tr> -->
                                <tr>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo number_format(sumPlain('p_ecd_enroll', 'p_bysch')); ?></td>
                                </tr>
                               <!--  <tr>
                                    <td>
                        ...
                        <div class="heading00">
                            <table id="hor-minimalist-b">
                                <tr class="highlighter_tr">
                                    ...
                                    <td class="td-left" style="width:200px"><?php echo number_format(sumArgs('a_bysch', 'ap_trt_m', 'ap_trt_f', 'ap_ecd_f', 'ap_ecd_m')); ?></td>
                        ...
                        <div class="content00">
                            ...
                            <!--     <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left">
                                        <?php echo number_format(numFlexible('p_sch_id', 'p_bysch', 'p_sch_bilharzia', 'Yes')) ?>
                        ...
                        <div class="content00">
                            <table id="hor-minimalist-b">
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo number_format(divisionValues(sumNonEnrolled6andover('STH'),num('school_id','a_bysch')),2,'.','')?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo numFlexible('school_id','a_bysch','a_6_18_total',0)?></td>
                        ...
                        <div class="content00">
                            <table id="hor-minimalist-b">
                                ...
                                <tr>
                                    ...
                                    <td class="td-left">
                                        <?php echo numDistinctPlain('attnt_district_name', 'attnt_bysch'); ?>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left">
                                        <?php echo number_format(num('attnt_division_name', 'attnt_bysch')) ?>
                                    </td>
                                </tr> 
                        ...
                        <div class="content00">
                            <table id="hor-minimalist-b">
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo numDistinctPlain('attnt_id','attnt_bysch') ?></td>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left">
                                        <?php echo numDistinctFlexible('attnt_id', 'attnt_bysch', 'attnt_sth', '1') ?>
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left">
                                        <?php echo numDistinctFlexible('attnt_id', 'attnt_bysch', 'attnt_schisto', '1') ?>
                                    </td>
                            ...
                            <table id="hor-minimalist-b">
                              ...
                              <!--   <tr>
                                ...
                                <tr>
                                    ...
                                    <td class="td-left"><?php echo numDistinctFlexible('school_id', 'attnt_bysch', 'attnt_schisto', '1') ?> </td>
                                </tr>
