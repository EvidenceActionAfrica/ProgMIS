          ...
          <div class="dashboard_menu">
            ...
            <div class="dashboard_export col-md-4 col-md-offset-2">
              ...
              <?php if ($priv_ciff_report >= 1) { ?>
                ...
                <!-- <a class="btn-custom-small" href="exportPdfDistrictPZQReport.php" target="_blank">Export To PDF</a>  -->
              <?php } ?>
            </div>
            <div class="vclear"></div>
            <div class="row col-md-offset-4">
              <h2>District SHISTO Report</h2>
            </div>
            <u><b>  NTD PZQ Dashboard </b></u> provides sub-county level statistics from form A on SCH treatment as is required for NTD reporting. The data included in this dashboard was collected at XX schools covering YY sub-counties between ZZ Month Year and ZZ Month Year
            <br/><br/>
          </div>
