			...
			<div id="indicator">
				...
				<div class="dashboard_menu">
					...
					<div class="dashboard_export">
						...
						<a class="btn-custom-small" href="exportExcelProgramKpi.php">Export To Excel</a>

						<a class="btn-custom-small" href="exportPdfProgramKpi.php" target="_blank">Export To PDF</a>
				...
				<table id="hor-minimalist-b">
					...
					<tr>
						...
						<td class="td-left"><?php echo $row15=number_format(sumUnder5()); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row16=number_format(sumPlain('a_treated_b','a_bysch')); ?></td>
					</tr>
					<tr>
						<td>
							No. of Non-enrolled (age 6-18) children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row17=number_format(sumNonEnrolled6andover('STH'));?></td>
					</tr>
					<tr>
						<td>
							No. of Non-enrolled (age 6-10) children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row18=number_format(sumNonEnrolledGender('a_6','a_bysch')) ?></td>
					</tr>
					<tr>
						<td>
							No. of Non-enrolled (age 11-14) children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row19=number_format(sumNonEnrolledGender('a_11','a_bysch')); ?></td>
					</tr>
					<tr>
						<td>
							No. of Non-enrolled (age 15-18) children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row20=number_format(sumNonEnrolledGender('a_15','a_bysch')) ?></td>
					</tr>
					<tr>
						<td>
							No. of Non Enrolled (age 2-5) children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row21=number_format(sumNonEnrolledGender('a_2','a_bysch')) ?></td>
					</tr>
					<tr>
						<td>
							No. of ECD children dewormed for STH
						</td>
						<td class="td-left"><?php echo $row22=number_format(sumArgs('a_bysch','a_ecd_m','a_ecd_f')); ?></td>
					</tr>
					<tr>
						<td>
							No. of districts covered for Schisto
						</td>
						<td class="td-left"><?php echo $row23=number_format(numDistinct('district_id','a_bysch','Yes')); ?></td>
					</tr>
					<tr>
						<td>
							No. of schools covered for Schisto
						</td>
						<td class="td-left"><?php echo $row24=number_format(numDistinct('school_id','a_bysch','Yes')); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row25=number_format(numSchoolTypeS('Public','Yes')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row26=number_format(numSchoolTypeS('Private','Yes')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row27=number_format(numSchoolTypeS('Other','Yes')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row28=number_format(numSchoolTypeS('Not specified','Yes')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row29=number_format(numDistinctP('district_id','Y')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row30=number_format(numDistinctP('p_sch_id','Y')); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row31=number_format(EstimatedTotalSHISTO()); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row32=number_format(sumEstimated('p_pri_enroll','Y')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row33=number_format(sumEstimated('p_ecd_enroll','Y')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row34=number_format(sumEstimated('p_ecd_sa_enroll','Y')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row35=number_format(number_format(sumSHISTO())) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row36=number_format(sumMaleFormAP()); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row37=number_format(sumFemaleFormAP()); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row38=number_format(sumArgs('a_bysch','ap_trt_m','ap_trt_f','ap_ecd_f','ap_ecd_m')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row39=number_format(sumArgs('a_bysch','ap_ecd_f','ap_ecd_m')); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row40=number_format(sumNonEnrolled6andover('SHISTO')); ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row41=number_format(sumNonEnrolledGender('ap_6','a_bysch')) ?></td>
					</tr>
					<tr>
						<td>
							No. of Non Enrolled (age 11-14) children dewormed for Schisto
						</td>
						<td class="td-left"><?php echo $row42=number_format(sumNonEnrolledGender('ap_11','a_bysch')) ?></td>
					</tr>
					<tr>
						<td>
							No. of Non Enrolled (age 15-18) children dewormed for Schisto
						</td>
						<td class="td-left"><?php echo $row43=number_format(sumNonEnrolledGender('ap_15','a_bysch')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row44=number_format(attntWithCriticalMaterials()) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row45=number_format(attntNoCriticalMaterials()) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row46=number_format(numFlexible('school_id','attnt_bysch','attnt_total_poles','1')) ?></td>
					...
					<tr>
						...
						<td class="td-left"><?php echo $row47=number_format(numFlexible('attnt_id','attnt_bysch','attnt_total_drugs','1')) ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row48=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row49=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row50=$data ?></td>

					</tr>
					<tr>
						<td class="kpi-not-done">
							No. of tablets picked by DMHO - ALB
						</td>
						<td class="kpi-not-done"><?php echo $row51=$data ?></td>

					</tr>
					<tr>
						<td>
							No. of tablets picked by DMHO - PZQ
						</td>
						<td><?php echo $row52=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row53=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row54=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row56=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row57=$data ?></td>
					...
					<tr>
						...
						<td class="kpi-not-done"><?php echo $row58=$data ?></td>
