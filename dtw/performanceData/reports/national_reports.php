                ...
                <div id="national_report_container">
                  ...
                  <div id="content_left" class="content">
                    ...
                    <div id="sth_pie_container">
                      ...
                      <canvas width="180" height="300" id="sth_enrollment_container_canvas" class="sth_canvas_style"></canvas>
                      <div id="sth_age_container" class="sth_pie_style" ></div>
                      <canvas width="180" height="300" id="sth_age_container_canvas" class="sth_canvas_style"></canvas>
                      <div id="sth_sex_container" class="sth_pie_style"></div>
                      <canvas width="180" height="300"id="sth_sex_container_canvas" class="sth_canvas_style"></canvas>
                    </div>
                  </div>
                ...
                $(document).ready(function() {
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      var clause = 'out of our goal of 11,000‏ schools.';
                      if (+contents[0] > +contents[1]) {
                        // clause = 'surpassing out goal of ' + contenfar surpassing our goal of 11,000 schoolsts[1] + ' schools!';
                        // clause = 'surpassing out goal of 11,000‏ schools!';
                        var clause = ' far surpassing our goal of 11,000‏ schools.';
                      }
                      createBar('#sth1_percentage_container', '#sth1_percentage_value', contents[0], contents[0] + ' schools reached,', '#sth1_info_title', contents[1], clause, '#sth1_info_title_sub');
                    }
                  });
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      var clause = ' out of our goal of 5,700,000 children';
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing 5,700,000 !';
                        var clause = ' significantly exceeding our goal of 5.7 million children!';
                  ...
                  $.post("national_ajax.php", {
                    ...
                    var contents = data.split(",");
                    if (contents.length == 2) {
                      // var clause = 'out of our goal of ' + contents[1] + ' districts';
                      var clause = 'out of 111 planned Sub-Counties';
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing our goal of 144 districts!';
                        var clause = 'meeting our goal of 111 sub-counties.';
                      } else {
                        clause = clause + '.';
                      }
                      createBar('#sth3_percentage_container', '#sth3_percentage_value', contents[0], contents[0] + ' Sub-Counties successfully completed deworming,', '#sth3_info_title', contents[1], clause, '#sth3_info_title_sub');
                    }
                  });
                  // create bar 4 data
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing our goal of 600,000‏ children!';
                        var clause = ' far surpassing our goal of 600,000‏ children.';
                      }
                  ...
                  $.post("national_ajax.php", {
                    ...
                    if (contents.length == 2) {
                      ...
                      var clause = 'out of 34 planned Sub-Counties.';
                      if (+contents[0] > +contents[1]) {
                        // clause = ' surpassing our target of ' + contents[1] + ' districts!';
                        // clause = ' surpassing our target of 64 districts!';
                        var clause = 'surpassing our goal of 34 districts!';
                      }
                      createBar('#sth5_percentage_container', '#sth5_percentage_value', contents[0], contents[0] + ' Sub-Counties successfully completed deworming,', '#sth5_info_title', contents[1], clause, '#sth5_info_title_sub');
