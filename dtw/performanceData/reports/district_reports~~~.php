                                    ...
                                    $.post("func.DistrictReport.php", {
                                        ...
                                        if (data == 0) {
                                            ...
                                            if (treatment_type == 'albe') {
                                                ...
                                                $('#report_subtitle_treatment_sumary').html('Annual coverage report for the treatment of soil-transmitted helminthiases (STH or common worms) with Albendazole at Kenyan primary schools between April 2013 and March 2014');
                                                ...
                                                $('#report_subtitle_treatment_sumary').html('Annual coverage report for the treatment of schistosomiasis with praziquantel at Kenyan primary schools between April 2013 and March 2014');
