...
$moe_trained = (4 * $district_num) + (3 * $division_num);
$mophs_trained = (3 * $district_num) + (3 * $division_num);
...
$children_targeted_plain = sumArgsByCountyOpenSchools('p_bysch', $county, 'p_ecd_enroll', 'p_ecd_sa_enroll', 'p_pri_enroll');
...
$pzq_children_targeted = sumMoreFexibleByCounty2('p_pri_enroll', 'p_bysch', 'county_name', $county, 'p_sch_bilharzia', 'Y', 'p_sch_closed', 'No');

//:::::Enrolled Children Planned  => total(p_pri_enroll) if p_sch_bilharzia=="Y" &  p_sch_closed=="No"
$pzq_enrolled_children_planned = $pzq_children_targeted;

//All Children Planned  =>total(p_pri_enroll/0.961) if p_sch_bilharzia=="Y" &  p_sch_closed=="No"
$pzq_children_planned = round($pzq_enrolled_children_planned / 0.961);
...
$pzq_school_targeted = CountMoreFlexible2('p_sch_id', 'p_bysch', 'county_name', $county, 'p_sch_bilharzia', 'Y', 'p_sch_closed', 'No');
...
//benchmakr===============================================================================
        ...
        echo '<table border="1" cellpadding="1" cellspacing="1" width="45%" align="center" class="county_report_table">
				 <tr><td width="80%">Schools planned</td><td width="20%" class="left-align" >' . number_format($pzq_school_targeted) . '</td></tr>
				 <tr><td>Schools participated</td><td class="left-align" >' . number_format($pzq_school_participated) . '</td></tr>
				 <tr><td>All children planned</td><td class="left-align" >' . number_format($pzq_children_planned) . '</td></tr>
				 <tr><td>All children dewormed</td><td class="left-align" >' . number_format($pzq_children_dewormed) . '</td></tr>
				 <tr><td>Enrolled children planned</td><td class="left-align" >' . number_format($pzq_enrolled_children_planned) . '</td></tr>
      <tr><td>Enrolled children dewormed</td><td class="left-align">' . number_format($pzq_enrolled_children_dewormed) . '</td></tr>
				 <tr><td>Non-enrolled children dewormed</td><td class="left-align" >' . number_format($pzq_non_enrolled_children_dewormed) . '</td></tr>
		 	</table>
			<table border="1" cellpadding="1" cellspacing="1" width="55%" align="center" class="county_report_table">
				...
				<tr><td>Est. sub-county/ward MoH Personnel trained</td><td class="left-align" >' . number_format($pzq_mophs_trained) . '</td></tr>
  <tr><td>Est. number of teachers trained</td><td class="left-align">' . number_format($pzq_est_number_teachers_trained) . '</td></tr>
			</table>';
    ...
    if ($data == "dewormed") {
        ...
        if ($treatment_type == 'albe') {
            ...
            if ($pzq_children_targeted == 0) {
                ...
                $pzq_primary_percentage = $pzq_enrolled_children_dewormed / ($pzq_children_targeted * 0.961) * 100;
            }
