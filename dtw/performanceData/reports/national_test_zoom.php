  ...
  $(function() {
    $( "#slider-range" ).slider({
      ...
      slide: function( event, ui ) {
        ...
        // var cow = ui.value+'px'
        console.log(cow);
        document.getElementById("national_report_container").style.zoom=cow;
        // document.getElementById("national_report_container").style['MozTransform']="scale(ui.value)";
        // document.getElementById("national_report_container").style['MozTransform']="scale("+ui.value+")";
        document.getElementById("wewe").style['-webkit-transform']="left top";
        // -moz-transform-origin:left top;
        // document.getElementById("national_report_container").style.width=ui.value;
...
<?php echo $her = rand(0,11);  echo "sdsdf";?>
 <p></p>
<p>
