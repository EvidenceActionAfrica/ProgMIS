  ...
  <body>
    ...
    <div class="contentMain">
      ...
      <div class="contentBody">
            ...
            <div class="rstBdy">
              <div class="inside">
                ...
                <div class="selSec">
                  ...
                  <select name="number_level" id="number_level">
                    <option value="1">Number of Schools</option>
                    <option value="2">Number of children</option>
                  </select>
                </div>
                </div>
                <p class="hthtxt">Category</p>
                <div class="chckSec">
                  <ul>
                    <li class="number_of_children">
                    ...
                    <li>
                      ...
                      <span>Private <input name="private" type="checkbox" value="" /></span>
                      <span>Public <input name="public" type="checkbox" value="public" /></span>
                      <span>Others <input name="others" type="checkbox" value="" /></span>
                    </li>
                    <li>
                    ...
                    <li class="number_of_schools">
                      <label>Choose School's status</label>
                      <span>Planned but not treated <input name="" type="checkbox" value="" /></span>
                      <span>Planned and treated<input name="" type="checkbox" value="" /></span>
                      <span>Not planned but Treated <input name="" type="checkbox" value="" /></span>
        ...
        <script>
                    // victor
                    $("#number_level").change(function() {
                      
                      var v=$(this).val();
                      console.log(v);
                      if (v=='2') {
                        $('.number_of_schools').hide();
                        $('.number_of_children').show();
                      };

                      if (v=='1') {
                        $('.number_of_children').hide();
                        $('.number_of_schools').show();
                      };
