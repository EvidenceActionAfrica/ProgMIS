                            ...
                            <div class="rstBdy">
                                ...
                                <div class="inside">
                                    ...
                                    <div class="selSec">
                                        ...
                                        <input style="background: #F14E6C;" id="generate_button" name="generate_repor" type="button" value="Generate Report" class="btn btn-primary" onClick="generateReport();" />
                                    ...
                                    <div id="report_container">
                                        ...
                                        <div class="section_header">
                                            County Deworming Facts at a Glance
                                        </div>
                                        ...
                                        <img src="images/logofooter2.png" alt="footer logo" height="50px" style="margin-left: 70px">
                                        <img src="images/logofooter3.jpg" alt="footer logo" height="50px" style="margin-left: 70px">
                                        <img src="images/logofooter4.jpg" alt="footer logo" height="50px" style="margin-left: 70px">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
                                    ...
                                    function generateReport() {
                                        ...
                                        if (treatment_type == 'albe') {
                                            ...
                                            $('#report_subtitle_treatment').html(countyname + ' County Soil-Transmitted Helminthes Treatment Results');
                                            // $('#report_subtitle_name').html( countyname+' County');
                                            // set the programme 
                                            $('#programme_title').html('Programme Coverage Summary for STH Treatment');
                                            $('#report_subtitle_treatment_sumary').html(' Annual coverage report for the treatment of soil-transmitted helminthiases (STH or common worms) with albendazole at Kenyan primary schools between April 2014 and March 2015');
                                            ...
                                            $('#report_subtitle_treatment').html(countyname + ' County Schistosomiasis Treatment Results');
                                            // $('#report_subtitle_name').html( countyname+' County');
                                            // set the programme 
                                            $('#programme_title').html('Programme Coverage Summary for Schistosomiasis Treatment');
                                            $('#report_subtitle_treatment_sumary').html('Annual coverage report for the treatment of schistosomiasis with praziquantel at Kenyan primary schools between April 2014 and March 2015');
                                    ...
                                    function setDewormed(value) {
                                        ...
                                        $('#dewormed_info_title_sub').html('out of ' + commaSeparateNumber(contents[1]) + ' planned children in the County. ');

                                        $('#dewormed_info_subtitle').html(commaSeparateNumber(parseInt(contents[2]).toFixed(0)) + '% of enrolled primary children were dewormed');
