<html>
  <head>
    ...
    if (isset($_GET['deleteid'])) {
      ...
      // delete
      $query = "DELETE FROM kemri_mt WHERE id='$deleteid'";

      $result = mysql_query($query) or die("Could not delete<br/>" . mysql_error());

      header("Location:kemriView.php?status=deleted");
    }

    $query = "SELECT * FROM kemri_mt";
  ...
  <body>
    ...
    <div class="contentBody">
      ...
      <div class="form-title"> 
        <h1>View Kemri Based Master Trainers</h1>
      </div>
      <form action="#">
        ...
        <a class="btn-custom-small" href="kemriMt.php">Create Kemri Based MT</a>
      </form>
              ...
              <tr style="border-bottom: 1px solid #B4B5B0;">
                ...
                <td align="center">
                  <div class="manage-header-links">
                    <li><a href="kemriEdit.php?id=<?php echo $data['id']; ?>">Edit  </a></li>
