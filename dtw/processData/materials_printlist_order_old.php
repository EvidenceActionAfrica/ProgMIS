...
$time_set=time();
$sql="INSERT INTO `materials_printlist_history`(`vendor_id`, `vendor_name`, `prepared_by`, `status`,`districts`,`time_set`)";
$sql.=" VALUES ('$vendorId','$vendorName','$preparedBy',1,'$disSelection','$time_set')";
// echo $sql."<br/>";
