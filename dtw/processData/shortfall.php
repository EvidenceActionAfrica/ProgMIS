...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
  ...
  <body>
    ...
    <div class="contentMain">
		...
		<!--tab skeleton-->
          <div class="tabbable" >
                  <ul class="nav nav-tabs">
                    <li class="<?php if ($tabActive == 'tab1') echo 'active'; ?>"><a href="#tab1" data-toggle="tab">Requisition Summary </a></li>

                      <li class="<?php if ($tabActive == 'tab2') echo 'active'; ?>"><a href="#tab2" data-toggle="tab">Get KEMSA</a></li>
                    <li class="<?php if ($tabActive == 'tab3') echo 'active'; ?>"><a href="#tab3" data-toggle="tab">Get from Another Sub County</a></li>
                    <li class="<?php if ($tabActive == 'tab4') echo 'active'; ?>"><a href="#tab4" data-toggle="tab">Get from Sub County Store</a></li>
              ...
              <form action="#">
                <td><input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus /></td>
                  ...
                  <div class="tab-content">
                     ...
                     $sql="SELECT * from counties as c,assumptions_district_list as ac WHERE c.county=ac.county_name ORDER BY county_name,district_name";
      ...
      $sql2="SELECT district_name,SUM(quantity_dispatched) as quantity from drugs_tablet_pickup_form WHERE district_name='".$row["district_name"]."'";
      //echo "<br/>";  
      $resultQ=mysql_query($sql2)or die(mysql_error());
        while($rows2=  mysql_fetch_array($resultQ)){
            $quantity=$rows2["quantity"];
        }if($quantity==""){$quantity=0;} 
                                echo "<tr>";
                                echo "<td>".$row["county_name"]."</td>";
                                echo "<td>".$row["district_name"]."</td>";
                                echo "<td>".number_format($row["total_alb"])."</td>";
                                 echo "<td>".number_format($row["total_pzq"])."</td>";
                                 echo "<td>".$quantity."</td>";
                                 $variance=$quantity-($row["total_alb"]+$row["total_pzq"]);
                                 echo "<td>".number_format(abs($variance))."</td>";
                                echo "</tr>";
          ...
          if (isset($_GET['deleteid_kemsa'])) {
            ...
            $tabActive="tab1";
             $deleteid = $_GET['deleteid_kemsa'];		        
            $sql="SELECT * from shortfall_kemsa WHERE id=".$deleteid;
            $result = mysql_query($sql) or die("<h1>Could not delete</h1><br/>" . mysql_error());
            ...
            $action="Kemsa Deleted";
            $description=" A Kemsa Shortfall for the sub-county  ".$district." was deleted.";
          ...
          <table width="100%" >
            ...
            <tr>
                ...
                <!--====  ADD kemsa ======-->
				  ...
				  $tabActive="tab1";
                    ...
                    echo " <div style='text-align:center;width:auto;margin:0 auto;padding:5px;border:1px solid #3eda00;border-radius:10px; margin:5px;background-color:#a2ff7e;'>
                     ...
                     $action="Kemsa Added";
                     $description=" A Kemsa Shortfall for the sub-county  ".$district." was Added.";
                     $ArrayData = array($M_module, $action, $description);
                     quickFuncLog($ArrayData);
                  }
                  ?>
                  <form action="" method="post">
                    ...
                    <table border="0" style="padding: 5px;">
                        <thead>  
                            <tr>
                              <td>Date  </td>
                              <td><input type="text" class="input_select_p compact" value="<?php echo date('d-m-Y'); ?>" readonly style="width: 100px"/></td>
                            </tr>
                            <tr>
                              <td>Sub County *  </td>
                              <td>
                                <select name="district"  class="input_select_p compact" style="width: 250px">
                                  <option value=''></option>
                                  <?php
                            ...
                            <tr>
                              ...
                              <td><input type="text" name="albendazoleNeeded" id="albendazoleNeeded" class="input_select_p compact"onkeyup="isNumeric(this.id);" style="width: 50px"/><span id="albendazoleNeededSpan"/></td>
                            </tr>
                            <tr>
                              <td>Praziquantel drugs needed </td>
                              <td><input align="right" type="text" name="praziquantelNeeded" id="praziquantelNeeded" class="input_select_p compact" onkeyup="isNumeric(this.id);" style="width: 50px"/><span id="praziquantelNeededSpan"/></td>
                            </tr>
              ...
              <td style="margin-left: 10%;width: 60%;">
                      ...
                      <table width="100%" border="0" align="center" cellspacing="1" class="table-hover" >
                        <thead>
                          <tr style="border: 1px solid #B4B5B0;">
                            ...
                            <th align="center" width="7%">Date<br/>Requested</th>
                            <th align="center" width="10%">Sub County</th>
                            <th align="center" width="8%">Albendazole</th>
                            <th align="center" width="8%">Praziquantel</th>
      ...
      <?php } ?>
                    ...
                    <table style="width:100%; overflow-x: visible; overflow-y: scroll; float: left" width="60%" border="0" frame="box" align="center" cellspacing="1" class="table-hover">
                      <tbody>
                        ...
                        while ($row = mysql_fetch_array($result_set)) {
                          ...
                          <tr style="border-bottom: 1px solid #B4B5B0;">
                            ...
                            <td align="center" width="7%"> <?php echo $dateSaved; ?>  </td>
                            <td align="center" width="10%"> <?php echo $district; ?>  </td>
                            <td align="center" width="8%"> <?php echo $albendazoleNeeded; ?>  </td>
                            <td align="center" width="8%"> <?php echo $praziquantelNeeded; ?>  </td>
      <?php if($priv_tab_pickup>=4){ ?>
      ...
      <?php } ?>
          ...
          if (isset($_GET['deleteid'])) {
            ...
            $result_set = mysql_query("SELECT * FROM shortfall_nearby_district WHERE id=".$deleteid." ORDER BY id DESC");
            while ($row = mysql_fetch_array($result_set)) {
              $id = $row['id'];
            ...
            $result = mysql_query($query) or die("<h1>Could not delete</h1><br/>" . mysql_error());
			      $tabActive="tab2";
            $action="Shortfall deleted from get Another sub-county tab";
            $description=" A Kemsa Shortfall transfer from sub-county  ".$district_from." to sub-county ".$district_to." was deleted.";
            $ArrayData = array($M_module, $action, $description);
            quickFuncLog($ArrayData);
          }
          ?>
                ...
                <!--====  ADD nearby ======-->
                  ...
                  if (isset($_POST['submitAdd_nearby'])) {
                    ...
                    echo " <div style='text-align:center;width:auto;margin:0 auto;padding:5px;border:1px solid #3eda00;border-radius:10px; margin:5px;background-color:#a2ff7e;'>
                     ...
                     $action="Shortfall transfer Added in the get Another sub-county tab";
                    $description=" A Kemsa Shortfall transfer from sub-county  ".$district_from." to sub-county ".$district_to." was added.";
                    $ArrayData = array($M_module, $action, $description);
                    quickFuncLog($ArrayData);
                  }
                  ?>
                      ...
                      <tbody>
                        <thead>
                          <tr style="border: 1px solid #B4B5B0;">
                            ...
                            <th align="Left" width="15%">Sub County<br/>From</th>
                            <th align="Left" width="10%">Sub County<br/>To</th>
      ...
      <?php } ?>
			      ...
			      <!--<div align="right"><a id="close1" href="#" title="Click This Button">Close</a></div>-->
          <h1 style="text-align: center; margin-top: 0px; font-size: 20px; ">Get from Sub County Store </h1>

          <?php
          //Delete
          if (isset($_GET['deleteid_store'])) {
            $deleteid = $_GET['deleteid'];
            $sql="SELECT * FROM shortfall_store  where id=".$deleteid." ORDER BY id DESC";
            ...
            $result = mysql_query($query) or die("<h1>Could not delete</h1><br/>" . mysql_error());
			      $tabActive = 'tab3';
            $action="Shortfall Added in the get Another sub-county tab";
            $description=" A Kemsa Shortfall for the sub-county  ".$district." was added.";
            $ArrayData = array($M_module, $action, $description);
            quickFuncLog($ArrayData);
          }
              ...
              <td style="width: 45%;border-right: 1px solid grey">
                <!--====  ADD store ======-->
                  ...
                  if (isset($_POST['submitAdd_store'])) {
                    ...
                    $action="Shortfall Added in the get from sub-county store tab";
                    $description=" A Kemsa Shortfall for the hospital ".$hospital." in the sub-county ".$district." was added";
                    $ArrayData = array($M_module, $action, $description);
                    quickFuncLog($ArrayData);
                  }
                  ?>
  ...
  <!---------------- Footer ------------------------>
        ...
        <script>
          ...
          function show_confirm_nearby(deleteid){
            if (confirm("Are you sure you want to delete?")) {
