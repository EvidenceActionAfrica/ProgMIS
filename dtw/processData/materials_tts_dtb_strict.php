  ...
  <link rel="stylesheet" type="text/css" href="css/modal.css"/>
    ...
    <body>
            ...
            <div class="contentBody" >
                <div class="tabbable" style="width:120%;" >
                    <ul class="nav nav-tabs">
                        ...
                        <li style="margin-left:35%;"<?php if ($tabActive == 'tab1') echo "class='active'" ?>><a href="#tab1" data-toggle="tab">Delivered District<br/> Training Boxes</a></li>
                        <li <?php if ($tabActive == 'tab2') echo "class='active'" ?>><a href="#tab2" data-toggle="tab">District Training<br/> Entry History</a></li>
                    ...
                    <div class="tab-content" style="max-height:650px; overflow:scroll;">
                        ...
                        <div class="tab-pane <?php if ($tabActive == 'tab1') echo 'active'; ?>" id="tab1">
                            <p><?php require_once("materials_acc_dtb_strict.php"); ?></p>

                        </div>
                        
                        <div class="tab-pane <?php if ($tabActive == 'tab2') echo 'active'; ?>" id="tab2">
                            <p><?php require_once("materials_acc_dtb_entry_strict.php"); ?></p>
                        </div> 
                       
                        <div class="tab-pane <?php if ($tabActive == 'tab3') echo 'active'; ?>" id="tab3">
                            <p><?php require_once("materials_acc_dtb_entry_data_strict.php"); ?></p>
                        </div> 
                ...
                if ($_GET["tab"] == "tab3") {
                    ?>
                    <h2 style="margin-left:25%;">District Training Box Totals</h2>
                    <table class="table table-bordered table-condensed " style="font-weight:bolder;">
                        <tr>
                        <th>REFERENCE</th>
                        ...
                        <?php
                        $sql = "select * from materials_packaging_history_data  WHERE county_name='$county' AND district_name='$district'";
                        $resultB = mysql_query($sql)or die(mysql_error());
                        while ($row = mysql_fetch_array($resultB)) {
                            $old_mtp+= $row["mtp"];
                            $old_dc_packet+= $row["dc_packet"];
                            $old_dpho_packet+= $row["dpho_packet"];
                            $old_dtb+= $row["dtb"];
                            $old_ttb+= $row["ttb"];
                            $old_hfd+= $row["hfd"];
                            $old_gdlm+= $row["gdlm"];
                            $old_ttk+= $row["ttk"];
                            $old_formA+= $row["form_a"];
                            $old_formAp+= $row["form_ap"];
                        ...
                        <tr style="background-color:#F4FA58;">
                            ...
                            <td><?php echo $old_mtp; ?></td>
                            <td><?php echo $old_dc_packet; ?></td>
                            <td><?php echo $old_dpho_packet; ?></td>
                            <td><?php echo $old_dtb; ?></td>
                            <td><?php echo $old_ttb; ?></td>
                            <td><?php echo $old_hfd; ?></td>
                            <td><?php echo $old_gdlm; ?></td>
                            <td><?php echo $old_ttk; ?></td>
                            <td><?php echo $old_formA; ?></td>
                            <td><?php echo $old_formAp; ?></td>
                        ...
                        <tr style="background-color:#bada66;">
                            <td><i>Total Collected</i></td>
                             <td><?php echo $total_mtp; ?></td>
                            <td><?php echo $total_dc_packet; ?></td>
                            <td><?php echo $total_dpho_packet; ?></td>
                            <td><?php echo $total_dtb; ?></td>
                            <td><?php echo $total_ttb; ?></td>
                            <td><?php echo $total_hfd; ?></td>
                            <td><?php echo $total_gdlm; ?></td>
                            <td><?php echo $total_ttk; ?></td>
                            <td><?php echo $total_formA; ?></td>
                            <td><?php echo $total_formAp; ?></td>
                        ...
                        <tr style="background-color:#FF8D8D">
                           ...
                           <td><?php echo $old_mtp-$total_mtp; ?></td>
                            <td><?php echo $old_dc_packet-$total_dc_packet; ?></td>
                            <td><?php echo $old_dpho_packet-$total_dpho_packet; ?></td>
                            <td><?php echo $old_dtb-$total_dtb; ?></td>
                            <td><?php echo $old_ttb-$total_ttb; ?></td>
                            <td><?php echo $old_hfd-$total_hfd; ?></td>
                            <td><?php echo $old_gdlm-$total_gdlm; ?></td>
                            <td><?php echo $old_ttk-$total_ttk; ?></td>
                            <td><?php echo $old_formA-$total_formA; ?></td>
                            <td><?php echo $old_formAp-$total_formAp; ?></td>
        ...
        <div id="addDTBQuantity" class="modalDialog" style="width:100%; ">
            <div >
                <div>
                    <a href="materials_tts_dtb_strict.php" title="Close" class="close">X</a>
