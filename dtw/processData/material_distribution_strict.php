  ...
  <h2 id="h2info" class='text-center'style="background:#bada66;"><?php echo $updateResult; ?></h2>
    <?php
              ...
              $numRows=mysql_affected_rows();
               ...
               if($numRows>=1){
    ?>
         <a href="materials_packing_strict.php?unpackVendor=1&tab=1" class="btn-custom" style="margin-left:40%;"/>Add/Remove Sub-County</a>
         <br/>
         <a href='materials_packing_strict.php?printPdf=summary'><img src="../images/print.png" height="20px"> Print Packaging Summary</a><br/>
          <table  class="table table-bordered table-condensed table-striped table-hover">
            <caption><h3><u>Materials Distribution</u></h3>
                ...
                $sql='SELECT distinct(training_box),training_box,training_box_desc from materials_desc ORDER BY training_box_desc ASC';
                ...
                while($rowTB=mysql_fetch_array($resultTB)){
                  echo '<th>'.$rowTB['training_box_desc'].'</th>';
                  array_push($trainingBoxArray,$rowTB['training_box']);
                }
          ...
          <?php
            ...
            while($row=mysql_fetch_array($resultA)){
               ...
               //Counts of boxes types per county & district. All Box types will be represent by this variable.Check Below
                ...
                $link="materials_packing_strict.php?printlistId=".urlencode($printlistId)."&countyName=".urlencode($countyName)."&districtName=".urlencode($districtName);
