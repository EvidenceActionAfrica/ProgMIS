...
<?php
$sql="SELECT * from materials_acc_ttb";
...
$sql="select * from materials_packaging_history_ttb WHERE collected=1 AND box_id=".$boxKey;
...
?>
 ...
 $link="materials_tts_strict.php?tab=tab5&county_name=$county&district_name=".$district."&boxId=".$boxId;
