...
if ($tabActive == 'tab4') {
    require_once ("includes/meta-link-script-george.php");
                ...
                <div >
                    ...
                    <div class="row">
                            ...
                            <div style="margin-left:10%;width:20%;float:left;">
                                    ...
                                    <input type="hidden" name="package_id" value="<?php echo $packageId; ?>" readonly/>
                           ...
                           <div style="margin-left:10%;width:20%;float:left;">
                            ...
                            foreach ($materialArray as $key => $value) {
                                ...
                                echo '                      <div style="margin-left:10%;width:20%;float:left;">
                                                               <label class="showTooltip" data-toggle="tooltip" data-placement="left" title="' . $key . '">' . $material . '</label><br>
                            ...
                            <input type="submit" style="margin-left:30%;" class="btn-custom" name="update-Box" value="Update Box" />
