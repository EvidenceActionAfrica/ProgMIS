          ...
          <div id="divData" style="padding-left: 3%; padding-right: 5%; background-color: #FCFCFC">
            ...
            <div style="width: 100%;">
              ...
              <table style="width: 100%">
                <tr>
                  ...
                  <td><b>DIVISION NAME: </b><input type="text" name="division" value="<?php echo $selecteddivision; ?>" style="border: none; border-bottom: 2px dotted #000; width: 40%;  background: #fcfcfc" readonly/></td>
            ...
            <table border="1" align="center" cellpadding="5" style="width: 100%; border: 2px solid black; font-size: 11px">
              <tr>
                ...
                <td rowspan="2" align="center"><b>Calculate number of PZQ required for Bilharzia Schools <br/><br/>((Ax2.5) +15%)<br/><br/> </b></td>
              </tr>
              <tr>
          ...
          <div id="divData2" style="padding-left: 3%; padding-right: 5%; background-color: #FCFCFC">
            <table style="width: 100%">
              <tr>
                ...
                <td align="center">
                  <b style="font-size: 28px; ">FORM P: DIVISION Planning</b> <br/>
            ...
            <table  style="border: 3px solid black; font-weight: normal; width: 100%">
              ...
              <tr><td><b style="font-size: 12px">Based on the programme in your Division last year the total number of teacher training sessions allocated this year is: <u style="font-size: 15px"><?php echo $mt_sessions; ?></u></b></td></tr>
            ...
            <table border="1" style="border: 3px solid black; font-weight: normal; width: 100%">
              ...
              <tr height="60px" style="font-size: 12px">
                ...
                <th colspan="2" style="width: 20%">Assigned Responsible MoEST and MoH Officer</th>
            ...
            <table align="left" border="1" style="border: 3px solid black; font-weight: normal; width: 100%;">
              ...
              <tr style="height: 30px">
                ...
                <th><b style="font-size: 15px">_____/_____/ 15 </b></th>
              </tr>
              <tr style="height: 30px">
