...
/*
	...
	?><!--
					...
					<td><a  class="btn btn-info" style="text-decoration:none;margin-top:5%;" target="blank" href="materials_packing.php?pdfTTB=<?php echo $district; ?>&county=<?php echo $county; ?>">View Pdf</a>
...
?>
	...
	$link="materials_packing.php?printlistId=".$printlistId." &countyName=".$county." &districtName=".$district;
...
<div id="addTTBox" class="modalDialog" style="width:120%;margin-left:-5%; ">
  <div >
    <form method="POST">
    <a href="materials_packing.php?tab=2" title="Close" class="close">X</a>
    <!-- ================= -->
<?php
