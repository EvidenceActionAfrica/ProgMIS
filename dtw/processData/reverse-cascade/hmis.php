...
?>
<html><head>
    <title>Evidence Action - Deworming Data Form D</title>
    ...
    <link type="text/css" rel="stylesheet" media="screen" href="hmis_files/jquery-ui-1.css">
    <link type="text/css" rel="stylesheet" media="screen,print" href="hmis_files/light_blue.css">
    <!-- <link type="text/css" rel="stylesheet" media="print" href="hmis_files/print.css"> -->
    <link rel="shortcut icon" href="https://hiskenya.org/favicon.ico">
  ...
  <body>
    ...
    <div id="header">
      <img id="headerBanner" src="hmis_files/logo_banner.png" onclick="window.location.href = '../dhis-web-dashboard-integration/index.action'" style="cursor:pointer" title="View home page">
      ...
      <span id="headerText" onclick="window.location.href = '../dhis-web-dashboard-integration/index.action'" style="cursor:pointer" title="View home page">
        Evidence Action - Deworming Data Form D
      </span>
    ...
    <div id="leftBar">
      <!--xemplar-->
      <div style="float: left">  <img src="../../images/logo.png" height=100px />  </div>
      <div style="clear: left"></div>
      <br/><br/><br/>
      <center>
        <a href="hmis.php#selectDistrictFormD" class="btn btn-small btn-primary">Select a District to enter data</a>
      </center>
    ...
    <div class="page" id="mainPage"> <!-- Do not set style attr -->
      ...
      <div class="contentBody">
        ...
        <form method="post" action="hmis.php#selectDistrictFormD">
          <div id="divData" style="padding-left: 3%; padding-right: 5%; background-color: #FCFCFC; border: 1px solid grey">
            <!--header-->
            <div style="width: 100%;">
          ...
          <!--         <td width="70px">
            ...
            <div style="width: 100%; padding-left: 3%; font-size: 11px; ">
              ...
              if ($treatment_type == 'STH/Schisto') {
                ?>
                • For completion in full by the SCHRIO.<br/>
            ...
            if ($treatment_type == 'STH/Schisto') {
              ...
              <div style="width: 100%;">
                <table style="width: 100%">
                 ...
                 <!--    <td width="70px">
                    ...
                    <td><img src="../../images/pill.png" height="50px"/></td>
                    <td align="center">
                      <b style="font-size: 17px; ">FORM D : DISTRICT REPORT PRAZIQUANTEL<br/></b>
                    </td>
              ...
              <center>
                <font style="font-size: 11px; text-align: center">SCHRIO: This side is to report treatment with Praziquantel using information on Form AP</font>
              </center>
              <br/>
               ...
               <!--   <td align="center">M</td>
                ...
                while ($row = mysql_fetch_array($result_st)) {
                  ...
                  <tr style="padding: 0px; margin: 0px">
                    ...
                    <td class="tdCompact">
                      <input class="txtTableForm fc num-only" type="text"name="dp_ecdTotal<?php echo $count_dp; ?>" id="dp_ecdTotal<?php echo $count_dp; ?>" readonly/>
                    </td>
                    <td class="tdCompact">
                    ...
                    <td class="tdCompact">
                      <input class="txtTableForm fc num-only" type="text" name="dp_esctTreatedTotal<?php echo $count_dp; ?>" id="dp_esctTreatedTotal<?php echo $count_dp; ?>" readonly/>
                    </td>
                   <!-- <td class="tdCompact">
  ...
  <!--                <td class="tdCompact">
          ...
          <br/>
            <input type="submit" name="addNewForm" value="Save & Submit" class="btn btn-primary"/>
        </form>
        <br/>
        <br/>
        <br/>
    ...
    <div id="rightBar">
      <span id="hideRightBar"><a href="javascript:hideHelpContent()" title="Close">
          <img id="hideRightBarImg" src="hmis_files/hide.png" alt="Close"></a>
      </span>
    ...
    </div><select style="visibility: hidden;" id="sharingPublicAccess_storage"></select></body></html>
...
<div id="selectDistrictFormD" class="modalDialog">
  <div style="width: 500px">
    ...
    ?>
    <!--======================-->
    <form method="POST" action="hmis.php">
      <center>
        <div style="padding: 5px; margin: 0px auto">
          <table border="0">
            ...
            <tr>
              <td>County </td>
              <td>
                <select onchange="get_district(this.value);" id="selectcounty" name="selectcounty" class="input_select_p compact">
            ...
            <tr>
              <td>District </td>
              <td>
                <select onchange="get_division(this.value);" id="selectdistrict" name="selectdistrict" class="input_select_p compact">
      ...
      <center>
        <div>
            <input type="submit" name="selectDistrictFormD" value="Select" class="btn btn-primary"/>
          <a href=hmis.php class="btn btn-primary" > Cancel</a>
        </div>
      </center>
    </form>
