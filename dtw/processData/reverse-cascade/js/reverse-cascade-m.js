$(document).ready(function(){
	...
	$(".return-status").on('click','td',function(){
			...
			// document.getElementById('tts_end_mt_input').value=tts_end_mt;
			//set the number input
			// document.getElementById('district_deworming_day_input').value=district_deworming_day;
			//set the checkboxes
			//use if statement. 
			if (rt_moe_recieved=='Y') {
				console.log(rt_moe_recieved);
				document.getElementById('rt_moe_recieved_checkbox').checked=true;
			};
			if (rt_mophs_recieved=='Y') {
				document.getElementById('rt_mophs_recieved_checkbox').checked=true;
			};
			if (tts_moe_recieved=='Y') {
				document.getElementById('tts_moe_recieved_checkbox').checked=true;
			};
			if (tts_mophs_recieved=='Y') {
				document.getElementById('tts_mophs_recieved_checkbox').checked=true;
			};
			if (dd_moe_recieved=='Y') {
				document.getElementById('dd_moe_recieved_checkbox').checked=true;
			};
			if (dd_mophs_recieved=='Y') {
				document.getElementById('dd_mophs_recieved_checkbox').checked=true;
			};


			function clear_return_form_checkboxes(){
				document.getElementById('rt_moe_recieved_checkbox').checked=false;
				document.getElementById('rt_mophs_recieved_checkbox').checked=false;
				document.getElementById('tts_moe_recieved_checkbox').checked=false;
				document.getElementById('tts_mophs_recieved_checkbox').checked=false;
				document.getElementById('dd_moe_recieved_checkbox').checked=false;
				document.getElementById('dd_mophs_recieved_checkbox').checked=false;
			}
	...
	$(".return-county").on('click','td',function(){
		...
		clear_county_returns_checkboxes();
		...
		if(moe_financial_returns_received=='Y'){
			document.getElementById('moe_financial_returns_received_checkbox').checked=true;
		}
		if(moe_attnc_received=='Y'){
			document.getElementById('moe_attnc_received_checkbox').checked=true;
		}
		if(moe_attnc_couriered=='Y'){
			document.getElementById('moe_attnc_couriered_checkbox').checked=true;
		}
		if(moh_financial_returns_received=='Y'){
			document.getElementById('moh_financial_returns_received_checkbox').checked=true;
		}
		if(moh_attnc_received=='Y'){
			document.getElementById('moh_attnc_received_checkbox').checked=true;
		}
		if(moh_attnc_couriered=='Y'){
			document.getElementById('moh_attnc_couriered_checkbox').checked=true;
		}
		if(moh_cd_recording_received=='Y'){
			document.getElementById('moh_cd_recording_received_checkbox').checked=true;
		}

		if(moh_cd_recording_couriered=='Y'){
			document.getElementById('moh_cd_recording_couriered_checkbox').checked=true;
		}


		//function clear the checkboxes
		function clear_county_returns_checkboxes(){
			document.getElementById('moe_financial_returns_received_checkbox').checked=false;
			document.getElementById('moe_attnc_received_checkbox').checked=false;
			document.getElementById('moe_attnc_couriered_checkbox').checked=false;
			document.getElementById('moh_financial_returns_received_checkbox').checked=false;
			document.getElementById('moh_attnc_received_checkbox').checked=false;
			document.getElementById('moh_attnc_couriered_checkbox').checked=false;
			document.getElementById('moh_attnc_received_checkbox').checked=false;
			document.getElementById('moh_cd_recording_received_checkbox').checked=false;
			document.getElementById('moh_attnc_received_checkbox').checked=false;
		}
