...
<ul>
 ...
 <a href="return-status.php"><li <?php if (strpos($url,'assumptions.php') !== false) { echo 'class="linkActive"';} ?> >Return Status</li></a>
 <a href="county-returns.php"><li <?php if (strpos($url,'schoolList.php') !== false) { echo 'class="linkActive"';} ?>  >County Returns</li></a>
 <a href="sad-returns.php"><li <?php if (strpos($url,'districtList.php') !== false) { echo 'class="linkActive"';} ?> >Form S'A'D</li></a>
</ul>
<br/>
