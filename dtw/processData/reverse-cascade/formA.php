	...
	<?php 
		...
		if (isset($_POST['submit'])) {
			...
			for ($i=0; $i <$number_of_schools ; $i++) { 
			  ...
			  $sheet_number=mysql_real_escape_string(htmlentities($sheet_number));
					$survey_id=mysql_real_escape_string(htmlentities($survey_id));
					$school_name=mysql_real_escape_string(htmlentities($school_name));
					$district=mysql_real_escape_string(htmlentities($district));
					$division=mysql_real_escape_string(htmlentities($division));
					...
					// $ecd_treated_male_total=mysql_real_escape_string(htmlentities($ecd_treated_male_total));
					// $ecd_treated_female_total=mysql_real_escape_string(htmlentities($ecd_treated_female_total));
					// $ecd_treated_children_total_total=mysql_real_escape_string(htmlentities($ecd_treated_children_total_total));
					...
					// $years_2_5_male_total=mysql_real_escape_string(htmlentities($years_2_5_male_total));
					// $years_2_5_female_total=mysql_real_escape_string(htmlentities($years_2_5_female_total));
					// $years_6_10_male_total=mysql_real_escape_string(htmlentities($years_6_10_male_total));
					// $years_6_10_fermale_total=mysql_real_escape_string(htmlentities($years_6_10_fermale_total));
					// $years_11_14_male_total=mysql_real_escape_string(htmlentities($years_11_14_male_total));
					// $years_11_14_female_total=mysql_real_escape_string(htmlentities($years_11_14_female_total));
					// $years_15_18_male_total=mysql_real_escape_string(htmlentities($years_15_18_male_total));
					// $years_15_18_female_total=mysql_real_escape_string(htmlentities($years_15_18_female_total));
					$non_enrolled_total=mysql_real_escape_string(htmlentities($non_enrolled_total));
					// $non_enrolled_total_total=mysql_real_escape_string(htmlentities($non_enrolled_total_total));
					...
					// $total_enrolled_in_register_total=mysql_real_escape_string(htmlentities($total_enrolled_in_register_total));
					// $enrolled_male_total=mysql_real_escape_string(htmlentities($enrolled_male_total));
					// $enrolled_female_total=mysql_real_escape_string(htmlentities($enrolled_female_total));
					// $enrolled_treated_total_total=mysql_real_escape_string(htmlentities($enrolled_treated_total_total));
					$aeo_name=mysql_real_escape_string(htmlentities($aeo_name));
					$aeo_phone_number=mysql_real_escape_string(htmlentities($aeo_phone_number));
					...
					if(!mysql_query("INSERT INTO form_a VALUES('$id',
						'$sheet_number',
						'$survey_id',
						'$school_name',
						'$district',
			...
			// just to totals
			  ...
			  $sheet_number = mysql_real_escape_string(htmlentities($sheet_number));
					 $survey_id = mysql_real_escape_string(htmlentities($survey_id));
			  		 $ecd_treated_male_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_male_grand_total));
					 $ecd_treated_female_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_female_grand_total));
					 $ecd_treated_children_total_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_children_total_grand_total));
					 $years_2_5_male_grand_total = mysql_real_escape_string(htmlentities($years_2_5_male_grand_total));
					 $years_2_5_female_grand_total = mysql_real_escape_string(htmlentities($years_2_5_female_grand_total));
					 $years_6_10_male_grand_total = mysql_real_escape_string(htmlentities($years_6_10_male_grand_total));
					 $years_6_10_female_grand_total = mysql_real_escape_string(htmlentities($years_6_10_female_grand_total));
					 $years_11_14_male_grand_total = mysql_real_escape_string(htmlentities($years_11_14_male_grand_total));
					 $years_11_14_female_grand_total = mysql_real_escape_string(htmlentities($years_11_14_female_grand_total));
					 $years_15_18_male_grand_total = mysql_real_escape_string(htmlentities($years_15_18_male_grand_total));
					 $years_15_18_female_grand_total = mysql_real_escape_string(htmlentities($years_15_18_female_grand_total));
					 $non_enrolled_total_grand_total = mysql_real_escape_string(htmlentities($non_enrolled_total_grand_total));
					 $total_enrolled_in_register_grand_total = mysql_real_escape_string(htmlentities($total_enrolled_in_register_grand_total));
					 $enrolled_male_grand_total = mysql_real_escape_string(htmlentities($enrolled_male_grand_total));
					 $enrolled_female_grand_total = mysql_real_escape_string(htmlentities($enrolled_female_grand_total));
					 $enrolled_treated_total_grand_total = mysql_real_escape_string(htmlentities($enrolled_treated_total_grand_total));

					
			
					$id='';
					
					if(!mysql_query("INSERT INTO form_a_grand_totals VALUES('$id',
						 '$sheet_number',
						 '$survey_id',
					...
					{
						echo 'Did not insert totals <br/>'.die(mysql_error());
					}
			  ...
			  // 	);
			  	 ...
			  	 $sheet_number = mysql_real_escape_string(htmlentities($grand_total_sheet_number));
					 $survey_id = mysql_real_escape_string(htmlentities($survey_id));
			  		 $ecd_treated_male_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_male_grand_total));
					 $ecd_treated_female_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_female_grand_total));
					 $ecd_treated_children_total_grand_total = mysql_real_escape_string(htmlentities($ecd_treated_children_total_grand_total));
