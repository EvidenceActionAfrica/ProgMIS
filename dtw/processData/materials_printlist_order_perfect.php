...
$others=mysql_query("SELECT * FROM others_extras ORDER BY id DESC LIMIT 1");
...
<table align="center" class="table table-bordered table-condensed table-striped table-hover">
  ...
  <tr><td>ATTNR MOE: Day 1:</td><td><?php echo $total_attnrmoeday1; ?> &nbsp; Day 2: &nbsp; <?php echo $total_attnrmoeday2; ?></td></tr>
  <tr><td>ATTNR MOH: Day 1:</td><td><?php echo $total_attnrmohday1; ?> &nbsp; Day 2: &nbsp;  <?php echo $total_attnrmohday2; ?></td></tr>
  ...
  <tr>
    ...
    <td><input readonly type="text" name="ttb" value="<?php echo $total_ttboxes_ttbooklets+$ex_teachtrain_booklet+$total_rtb_ttb; ?>" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input readonly type="text" name="css" value="<?php echo $total_css_perdiv+$ex_commsens_sup+$total_css_perdist; ?>" /></td>
  </tr>
  <tr>
...
-->
  <tr>
    <td>Poster 1:</td>
    <td><input readonly type="text" name="poster1" value="<?php echo $total_rtb_posterA ?>" /></td>
  </tr>
  <tr>
    <td>Poster 2:</td>
    <td><input readonly type="text" name="poster2" value="<?php echo $total_rtb_posterB ?>" /></td>
  </tr>
  <!--
  <tr>
