                ...
                <td style="width: 60%">
                  <table border="2" align="center" cellpadding="0" style="width: 100%;">
                    ...
                    <tr>
                      ...
                      <td align="center" width="200px"><input type="text" id="listed_km" name="listed_km" value=""  onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td>Fuel is calculated using the 30KShs per Kilometre GoK provided rate (Ministry of Public Works Cirrcular)</td>
                      <td><input type="text" id="fuel" name="fuel" value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td>Agreed upon Fuel Amount to be given to CHC</td>
                      <td><input type="text" id="fuel_amount" name="fuel_amount" value=""  onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td>Lunch for Driver to Drive to NBO to receive the drugs</td>
                      <td><input type="text" id="driver_lunch" name="driver_lunch"  value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td>Lunch for County Pharmacist escorting driver</td>
                      <td><input type="text" id="county_pharmacist" name="county_pharmacist"  value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td>Coordination Allowance for CHC</td>
                      <td><input type="text" id="allowance" name="allowance"  value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td><b>TOTAL AMOUNT NEEDED BY CHC</b></td>
                      <td><input type="text" id="total" name="total"  value=""  onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);"class="txt-input-table-center"/></td>
                    </tr>
                    <tr height="20px">
                      <td><b></b></td>
                      <td></td>
                    ...
                    <tr>
                      ...
                      <td><input type="text" id="chc_name" name="chc_name"  value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                    <tr>
                      <td align="right">CHC's Mpesa Phone No.</td>
                      <td><input type="text" id="chc_mpesa_phone" name="chc_mpesa_phone"  value="" onBlur="calculateAssumptions();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                    </tr>
                  </table><br/><br/>
                </td>
              ...
              <div style="width: 100%;"  >
                  ...
                  <form method="post">
                    ...
                    <!-- table begin  =============-->
                      ...
                      <table border="2" align="center" cellpadding="0" style="width: 550px;margin-left:40%;margin-top:-8%;">
                        <thead>
                        <tr style="background-color: silver;">
                          <td colspan="6" style="padding: 5px;"><b>CHC CASH REQUISITION SUMMARY SHEET <br/>   Calculation Table  </b></td>
                        </tr>
                        ...
                        <tr>
                          <td>Agreed upon Fuel Amount to be given to CHC</td>
                          <td><input type="text" id="fuel_amount2" name="fuel_amount" value="<?php echo $fuel_amount ?>" onBlur="calculateAssumptions2();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                        </tr>
                        <tr>
                          <td>Lunch for Driver to Drive to NBO to receive the drugs</td>
                        ...
                        <tr>
                          <td><b>TOTAL AMOUNT NEEDED BY CHC</b></td>
                          <td><input type="text" id="total2" name="total"  value="<?php echo $total; ?>" onBlur="calculateAssumptions2();" onKeyUp="isNumericErase(this.id);" class="txt-input-table-center"/></td>
                        </tr>
                <tr>
                      <td align="right">CHC's Name</td>
                ...
                <td >
                  ...
                  <br/> <br/>
                  <b> Accountability Documents to be received  </b><br/>
                  <textarea cols="50" rows="8" id="account_documents2" name="account_documents" placeholder=""><?php echo $account_documents; ?></textarea>
                  <br/> <br/>
                  
   <?php if( $priv_dispatch>=1){ ?>
                  <a href="javascript:void(0)" style="float: left" class="btn-custom-tiny" onclick="calculateAssumptions22();"> Confirm calculations</a>
