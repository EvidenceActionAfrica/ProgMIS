    ...
    <div class="contentMain">
      ...
      <div class="contentBody" >
        ...
        <form action="#">
          ...
          <?php } ?>
          <b style="margin-left:20%;width: 100px; font-size:1.5em;">Master Trainers National</b>
            ...
            <tbody>
              ...
              while ($row = mysql_fetch_array($result_set)) {
                ...
                if ($priv_master_trainers >= 3) {
                  $link = "masterTrainers.php?editDetails=1&id=$id#editMT";
                } else {
                  $link = "#";
                }
                ?>
        ...
        <div style="float: left; width: 49%;">
          ...
          <table border="0">
            <thead>
              <tr>
                ...
                <td>
                  <select name="county"  class="input_select" style="width:210px;"  >
                    <option value='Nairobi'<?php if ($county == '') echo 'selected'; ?> >Nairobi</option>
                  </select>
                </td>
              </tr>
              <tr>
              ...
              <tr>
                <!--<td>Posting Station </td><td><input type="text" name="posting_station" class="input_textbox" placeholder="" value="Nairobi" style="width:200px;"  /></td>-->
              </tr>
              <tr>
                <td>Level</td>
                <td>
...
<div id="editMT" class="modalDialog">
  <div style="width:750px">
    ...
    <form action="" method="post">
      ...
      <center>
        <div>
          <input type="submit" class="btn-custom" name="submitEditMT"  value="Edit MT National Details"/>
        </div>
      </center>
    </form>
  </div>
