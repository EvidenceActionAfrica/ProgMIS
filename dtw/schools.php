                    ...
                    <table width="100%" border="0" align="center" cellspacing="1" class="table-hover" >
                      <thead>
                        <tr style="border-bottom:0px;">
                          ...
                          <th align="center" width="13%"1><input type="text" style="width: 98%" name="school_name"  value="<?php echo $school_name ?>"/></th>
                          <th align="center" width="8%"><input type="text" style="width: 98%" name="school_id"    value="<?php echo $school_id ?>"/></th>
                          ...
                          <th align="center" width="5%" colspan="1"><input type="submit" class='btn-filter' id="btnSearchSubmit" style="width: 98%" value="Search" name="search_table"  /></th>
                        </tr>
                      </thead>
                    </table>
                  </form>
                  ...
                  <table id="data-table" class="table table-responsive table-hover table-stripped">
                    <thead>
                      <tr style="border-bottom: 1px solid #B4B5B0;">
                        ...
                        <th width="9%">Sub-Counties</th>
                        <th width="9%">Division</th>
                        <th width="11%">School Name</th>
                        <th width="8%">School ID</th>
                        <th width="8%">School Type</th>
                        <?php if ($priv_divisions >= 4) { ?>
                          <th>Del</th>
                        <?php } ?>
                      </tr>
                    ...
                    <tbody>
                      ...
                      while ($row = mysql_fetch_array($result_set)) {
                        ...
                        if ($priv_divisions >= 3) {
                          $link = "schools.php?id=$id&editDetails=1#editSchool";
                        } else {
                          $link = "schools.php?id=$id&viewDetails=1#viewSchool";
                        }
                        ?>
                        <tr>

                          <td> <?php echo "<a href=$link>" . $county . "</a>"; ?>  </td>
                          <td> <?php echo "<a href=$link>" . $district_name . "</a>"; ?> </td>
                          <td> <?php echo "<a href=$link>" . $division_name . "</a>"; ?> </td>
                          <td> <?php echo "<a href=$link>" . $school_name . "</a>"; ?> </td>
                          <td> <?php echo "<a href=$link>" . $school_id . "</a>"; ?> </td>
                          <td> <?php echo "<a href=$link>" . $school_type . "</a>"; ?>  </td>
                          <?php if ($priv_divisions >= 4) { ?>
...
<p></p>
<?php
$sql = "SELECT timestamp from `schools` order by timestamp desc limit 1";
...
?>
          ...
          <div id="addSchool" class="modalDialog">
            <div  style="width:680px">
              ...
              if (isset($_POST['submitAddSchool'])) {
                ...
                $school_name = $_POST['school_name'];
                $school_type = $_POST['school_type'];
				$num_tot_child = $_POST['num_tot_child'];
				...
				$num_tot_child = addslashes(trim($num_tot_child));
                ...
                //Get Division Code
                $result = mysql_query("SELECT RIGHT(division_id,3)  FROM divisions  WHERE district_name = '$district_name' AND division_name = '$division_name' ");
                while ($row = mysql_fetch_array($result)) {
                ...
                if ($avail_school == 0) {
                  ...
                  $query = ( "INSERT INTO schools (county,county_id,district_id,district_name,division_id,division_name,school_name,school_id,school_type, num_tot_child) VALUES (
                        '$county',
                        '$county_id',
						'$district_id',
                        '$district_name',
                    ...
                    <table border="0">
                      <thead>
                        ...
                        <tr>
                          ...
                          <td><input type="text" name="num_tot_child" class="input_textbox" placeholder="" value="" required /></td>
                        </tr>
                      </thead>
                    </table>
                  </div>
            ...
            <div  style="width:680px">
              ...
              if (isset($_GET['editDetails'])) {
                ...
                while ($row = mysql_fetch_array($result_st)) {
                  ...
                  $school_id = $row['school_id'];
                  $school_type = $row['school_type'];
				  $nunm_tot_child = $row['$num_tot_child'];
                }
              }
              if (isset($_POST['submitEditSchool'])) {
                ...
                //Check if school_name Exists
                $query1 = "SELECT * FROM schools WHERE county = '$county' AND district_name = '$district_name' AND division_name = '$division_name' AND school_name = '$school_name' AND school_type = '$school_type' AND num_tot_child = '$num_tot_child' LIMIT 1";
                $check_school = mysql_query($query1);
                $avail_school = mysql_num_rows($check_school);
                if ($avail_school == 0) {
                  $query = ( "UPDATE schools SET
					  ...
					  num_tot_child = '$num_tot_child' WHERE id='$id' " );
                ...
                <div style="padding: 5px;">
                  ...
                  <div style="float: left; width: 49%">
                    ...
                    <table border="0">
                      ...
                      <tr>
                        <td>Total number of children</td>
                        <td><input type="text" name="num_tot_child" class="input_textbox" value="<?php echo $num_tot_child; ?>" required/></td>
                      </tr>
                    </table >
                  </div>
                </div><div class="vclear"></div>
          ...
          <div id="importCSV" class="modalDialog">
            <div style="width:380px">
              <a href="#close" title="Close" class="close">X</a>
              <div >
                <h1 class="form-title">Upload schools </h1><br/>
              </div>
              - Uploading a new list replaces the existing one<br/>
              - ensure the ID column has a title to avoid "column count" error<br/>
              - leave the ID numbers blank to avoid "duplicate IDs" error<br/>
              <br/><br/>
              <?php
              if (isset($csvMessage)) {
          ...
          <div id="viewSchool" class="modalDialog">
            <div  style="width:680px">
              ...
              if (isset($_GET['viewDetails'])) {
                ...
                $result_st = mysql_query("SELECT * FROM school WHERE id='$id'");
                while ($row = mysql_fetch_array($result_st)) {
                  $county = $row['county'];
                  $district_name = $row['district_name'];
                  $division_name = $row['division_name'];
                  ...
                  $school_id = $row['school_id'];
                  $school_type = $row['school_type'];
				  $num_tot_child = $row['num_tot_child'];
                }
              }
              ?>
              <div style="padding: 5px;">
