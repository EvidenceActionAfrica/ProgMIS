...
var b = columns[2];
          ...
          /*  $.each(versions, function (key, value) {
			...
			var lgrk = '';
			<?php if($_REQUEST['selectchart']=='pie'){ echo"hello pie chart"; return;?>
				lgrk = 'Pie Chart';
...
var b = columns[2];
          ...
          /*  $.each(versions, function (key, value) {
			...
			var lgrk = '';
			<?php if($_REQUEST['selectchart']=='pie'){ echo "hello status"; return;?>
...
var b = columns[2];
          ...
          /*  $.each(versions, function (key, value) {
			...
			var lgrk = '';
			<?php if($_REQUEST['selectchart']=='pie'){ echo "hello age"; return;?>
				lgrk = 'Age Bracket';
			<?php }else if($_REQUEST['selectchart']=='line'){?>
				lgrk = 'Line Graph';
			<?php }else if($_REQUEST['selectchart']=='bar'){?>
...
var b = columns[2];
          ...
          /*  $.each(versions, function (key, value) {
			...
			var lgrk = '';
			<?php if($_REQUEST['selectchart']=='pie'){ echo "hello sex"; return;?>
				lgrk = 'Sex';
			<?php }else if($_REQUEST['selectchart']=='line'){?>
				lgrk = 'Line Graph';
			<?php }else if($_REQUEST['selectchart']=='bar'){?>
