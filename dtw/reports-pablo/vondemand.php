    ...
    <div class="contentMain">
      ...
      <div class="contentBody">
              ...
              <div class="inside">
                ...
                <div>
                  ...
                  <select name="level" id="level">
                    <option>Number of Schools</option>
                    <option>Number of children</option>
                  </select>
                </div>
                <div>
                  <label class="hthtxt">Category</label>
                  <div class="vclear"></div>

                    <div>
                      <label>Level 1</label>
                      <select name="level1" id="vlevel1">
                        <option value="gender">Gender</option>
                        <option value="age">Age</option>
                        <option value="enrollment">Enrollment</option>
                        <option value="school_type">School Type</option>
                        <option value="treatment_type">Treatement Type</option>
                      </select>
                      <select name="level1b" id="vlevel1b">                  
                      </select>
                    </div>
                    <div>
                      <label>Level 2</label>
                      <select name="level2" id="vlevel2"></select>
                      <select name="level2b" id="vlevel2b"></select>
                    </div>
                    <div>
                      <label>Level 3</label>
                      <select name="level3" id="vlevel3">
                      </select>
                    </div>
                </div>
                ...
                <div class="chckSec">
                  <ul>
                    <li>
                      ...
                      <span>Public <input name="" type="checkbox" value="" /></span>
        ...
        <script type="text/javascript">
          ...
          $("#vlevel1").change(function() {
             
             $.get('onDemandFunctions.php?drop=' + $(this).val(), function(data) {
                $("#vlevel2").html(data);
              });
          ...
          $("#vlevel2").change(function() {
             
             // $.get('onDemandFunctions.php?drop=' + $(this).val(), function(data) {
             //    $("#vlevel3").html(data);
             //    });

             $.get('onDemandFunctions2.php?drop2=' + $('#vlevel1').val(), function(data) {
                $("#vlevel1b").html(data);
                });
               console.log('ddd');
          ...
          // $("#vlevel3").change(function() {
             
          //    $.get('onDemandFunctions.php?drop=' + $(this).val(), function(data) {
          //       $("#vlevel3").html(data);
          //       });

          //    $.get('onDemandFunctions.php?drop3=' + $('#vlevel2').val(), function(data) {
          //       $("#vlevel2b").html(data);
          //       });
