    ...
    <link rel="stylesheet" type="text/css" href="css/textext.core.css">
      <link rel="stylesheet" type="text/css" href="css/textext.plugin.tags.css">
        <link rel="stylesheet" type="text/css" href="css/textext.plugin.autocomplete.css">
          ...
          <body onload="document.getElementById('imgLoading').style.visibility = 'hidden';">
            ...
            <div class="contentMain">
              ...
              <div class="contentBody">
                ...
                function row_total() {
                    $query_row = "SELECT * FROM headteachers";
          ...
          <?php } ?> <b style="margin-left:20%;width: 100px; font-size:1.5em;">Head Teachers</b>
                    ...
                    <table width="100%" border="0" align="center" cellspacing="1" class="table-hover" >
                      <thead>
                        <tr style="">
                          ...
                          <th align="center" width="16%"><input type="text" style="width: 98%" name="school_name"  value="<?php echo $school_name; ?>"/></th>
                          <th align="center" width="15%"><input type="text" style="width: 98%" name="fullName"    value="<?php echo $fullName; ?>"/></th>
                          <th align="center" width="9%"><input type="text" style="width: 98%" name="phone"    value="<?php echo $phone; ?>"/></th>
                          ...
                          <th align="center" width="6%" colspan="1"><input type="submit" class='btn-filter' id="btnSearchSubmit" style="width: 98%" value="Search" name="search_table"  /></th>
                        </tr>
                      </thead>
                    </table>
                  </form>
                ...
                <thead>
                  ...
                  <tbody>
                      ...
                      while ($row = mysql_fetch_array($result_set)) {
						...
						if($priv_headteachers>=3){
							$link = "headteachers.php?id=$id&editDetails=1#editSchool";
						}else{
							$link = "headteachers.php?id=$id&viewDetails=1#viewSchool";
			  
						}
                        ?>
                        <tr style="border-bottom: 1px solid #B4B5B0;">

                          <td align="left" > <?php echo "<a href=$link>".$county."</a>"; ?>  </td>
                          <td align="left" > <?php echo "<a href=$link>".$district_name."</a>"; ?> </td>
                          <td align="left" > <?php echo "<a href=$link>".$division_name."</a>"; ?> </td>
                          <td align="left" > <?php echo "<a href=$link>".$school_name."</a>"; ?> </td>
                          <td align="left" > <?php echo "<a href=$link>".$fullName."</a>"; ?> </td>
                          <td align="left" > <?php echo "<a href=$link>".$phone."</a>"; ?>  </td>
                          <td align="left"> <?php echo "<a href=$link>".$treatment_type."</a>"; ?>  </td>
                    ...
                    <b style="padding-bottom: 2%; padding-left: 1%" > Total Number of records: <?php echo number_format(row_total()); ?></b> 
                </div>
                <br/>
<?php
$sql = "SELECT timestamp from `headteachers` order by timestamp desc limit 1";
 ...
 <script type="text/javascript">
          ...
          <div id="addHeadTeacher" class="modalDialog">
            <div style="width:680px">
              ...
              <?php
              if (isset($_POST['submitAddHeadTeacher'])) {
                //Posted Values
              ...
              <form action="" method="post">
                ...
                <div >
                  <h1 class="form-title">Add Head Teacher</h1><br/>
                </div>
                ...
                <center>
                  <div>
                    <input type="submit" class="btn-custom" name="submitAddHeadTeacher"  value="Add HeadTeacher"/>
                  </div>
                </center>
              </form>
            </div>
		...
		while ($row = mysql_fetch_array($result_st)) {
              ...
              if (isset($_POST['submitEditSchool'])) {
                ...
                $phone2 = addslashes(trim($phone2));
                     ...
                     $sql.="`phone2`='$phone2',`treatment_type`='$treatment_type', timestamp = CURRENT_TIMESTAMP WHERE id='".$id."'";
              ...
              <form action="" method="post">
                ...
                <center>
                  <div>
                    <input type="submit" class="btn-custom" name="submitEditSchool"  value="Edit Teacher Details"/>
                  </div>
                </center>
              </form>
            </div>
...
<div id="importCSV" class="modalDialog">
  <div style="width:380px">
    <a href="#close" title="Close" class="close">X</a>
    <div >
      <h1 class="form-title">Upload Head Teachers</h1><br/>
    </div>
<?php
