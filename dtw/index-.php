      ...
      <div style="width:400px">
        ...
        if (isset($_POST['submitAddemail'])) {
          ...
          if ($avail_email > 0) {
            ...
            $rows = mysql_fetch_array($resultFetch);
            $staff_password = $rows['staff_password'];
            

            $email_body = 'Your password is : <b>' . $staff_password . '</b> <br/> ';
            ...
            try {
              ...
              $mail->Subject = "DtW Password Recovery";
            ...
            // end of send email ============================
            $messageToUser = "Your password has been sent to your email address!";
        ...
        <?php include("includes/messageBox.php"); ?>
          <div >
            <h1 class="form-title">Password Recovery</h1><br/>
          </div>
          <center>
          ...
          <center>
            <div>
              <input type="submit" class="btn-custom" name="submitAddemail"  value="Recover Password"/>                    
            </div>
          </center>
        </form>
      </div>
