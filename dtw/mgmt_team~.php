          ...
          <form method="post">
            <table width="100%" border="0" align="center" cellspacing="1" class="table-hover" >
              <thead>
                <tr style="">
                  ...
                  <th align="center" width="15%"><input type="text" style="width: 98%" name="mobile2"  value="<?php echo $mobile2; ?>"/></th>
        
                  <th align="center" width="30%"><input type="text" style="width: 98%" name="email1"  value="<?php echo $email1; ?>"/></th>
                  <th align="center" width="30%"><input type="text" style="width: 98%" name="email2"  value="<?php echo $email2; ?>"/></th>
              ...
              <table id="data-table" class="table table-responsive table-hover table-stripped">
                  ...
                  <th align="Left" width="15%">Mobile2</th>
                  <th align="Left" width="30%">Email1</th>
                  <th align="Left" width="30%">Email2</th>
                  <th>Job Group</th>
                
                  <?php if ($priv_mgmt_team >= 3) { ?>
           ...
           <tbody>
              ...
              while ($row = mysql_fetch_array($result_set)) {
                ...
                $email2 = $row['email2'];
                if($priv_mgmt_team>=1){
                $link = "mgmt_team.php?id=$id&viewDetails=1#viewMoH";
 }else{
                $link = "mgmt_team.php#";
                ...
                <tr style="border-bottom: 1px solid #B4B5B0;">
                  ...
                  <td align="left" width="15%"><?php
                    ...
                    echo "<a href=$link>".substr($mobile2, 0, 12);
                    if (strlen($mobile2) > 12)
                      echo "..";
                      echo "</a>";
                    ?>
                  </td>
                  ...
                  <td align="left" width="30%"><?php
                    ...
                    echo "<a href=$link>".substr($email2, 0, 30);
                    if (strlen($email2) > 30)
                      echo "..";
                       echo "</a>";
                    ?>
        ...
        <div style="width:49%;margin-left:35%;">
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
             ...
             <tr>
                <td> Contact Phone1 </td><td><input type="text" name="mobile1" id="mobile2" class="input_textbox_p compact" placeholder="254" onKeyUp="isNumeric(this.id);"/><span id="mobile1Span"></span></td>
              </tr>
             <tr>
                <td> Contact Phone2 </td><td><input type="text" name="mobile2" id="mobile2" class="input_textbox_p compact" placeholder="254" onKeyUp="isNumeric(this.id);"/><span id="mobile2Span"></span></td>
              </tr>
             
                <tr>
                <td> Contact Email1 </td><td><input type="email" name="email1" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td> Contact Email2 </td><td><input type="email" name="email2" class="input_textbox_p compact" /></td>
              </tr>
        ...
        <div style="width:49%;margin-left:35%;">
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
             ...
             <tr>
                <td> Contact Phone1 </td><td><input type="text" name="mobile1" id="mobile1" class="input_textbox_p compact" placeholder="254" value="<?php echo $mobile1; ?>" onKeyUp="isNumeric(this.id);"/><span id="mobile1Span"></span></td>
              </tr>
              <tr>
                <td> Contact Phone2 </td><td><input type="text" name="mobile2" id="mobile2" class="input_textbox_p compact" placeholder="254" value="<?php echo $mobile2; ?>" onKeyUp="isNumeric(this.id);"/><span id="mobile2Span"></span></td>
              </tr>
  
                <tr>
                <td> Contact Email1 </td><td><input type="email" name="email1" class="input_textbox_p compact" value="<?php echo $email1; ?>" /></td>
              </tr>
              <tr>
                <td> Contact Email2 </td><td><input type="email" name="email2" class="input_textbox_p compact" value="<?php echo $email2; ?>" /></td>
              </tr>
        ...
        <div style="width:49%;margin-left:35%;">
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
             ...
             <tr>
                <td> Contact Phone1 </td><td><input type="text" name="mobile1" id="mobile1" class="input_textbox_p compact" placeholder="254" value="<?php echo $mobile1; ?>" onKeyUp="isNumeric(this.id);" disabled/><span id="mobileSpan1"></span></td>
              </tr>
             <tr>
                <td> Contact Phone2 </td><td><input type="text" name="mobile2" id="mobile2" class="input_textbox_p compact" placeholder="254" value="<?php echo $mobile2; ?>" onKeyUp="isNumeric(this.id);" disabled/><span id="mobileSpan2"></span></td>
              </tr>

                <tr>
                <td> Contact Email1 </td><td><input type="email" name="email1" class="input_textbox_p compact" value="<?php echo $email1; ?>" disabled/></td>
              </tr>
                <tr>
                <td> Contact Email2 </td><td><input type="email" name="email2" class="input_textbox_p compact" value="<?php echo $email2; ?>" disabled/></td>
              </tr>
