            ...
            <tbody>
              ...
              while ($row = mysql_fetch_array($result_set)) {
                ...
                <tr>
                  ...
                  <?php if ($priv_county_contacts >= 3) { ?>
                    <!--edit button-->
                    <form method="POST" action="#editCCounty">
...
<div id="addCountyContact" class="modalDialog">
  <div>
    ...
    if (isset($_POST['submitAddCounty'])) {
      ...
      $additional_contact_name = $_POST['additional_contact_name'];
      $additional_contact_phone = $_POST['additional_contact_phone'];
      $additional_contact_phone2 = $_POST['additional_contact_phone2'];
      $additional_contact_email = $_POST['additional_contact_email'];
      $bank_account_name = $_POST['bank_account_name'];
      $bank_account_number = $_POST['bank_account_number'];
      $bank_name = $_POST['bank_name'];
      $bank_branch = $_POST['bank_branch'];
      $pot_bank_account_name = $_POST['pot_bank_account_name'];
      $pot_bank_account_number = $_POST['pot_bank_account_number'];
      $pot_bank_name = $_POST['pot_bank_name'];
      $pot_bank_branch = $_POST['pot_bank_branch'];
      ...
      $additional_contact_name = addslashes(trim($additional_contact_name));
      $additional_contact_phone = addslashes(trim($additional_contact_phone));
      $additional_contact_phone2 = addslashes(trim($additional_contact_phone2));
      $additional_contact_email = addslashes(trim($additional_contact_email));
      ...
      $pot_bank_account_name = addslashes(trim($pot_bank_account_name));
      $pot_bank_account_number = addslashes(trim($pot_bank_account_number));
      $pot_bank_name = addslashes(trim($pot_bank_name));
      $pot_bank_branch = addslashes(trim($pot_bank_branch));
      ...
      $query = ( "INSERT INTO county_contacts (
            ...
            additional_contact_phone2,
            additional_contact_email,
            bank_account_name,
            bank_account_number,
            bank_name,
            bank_branch,
            pot_bank_account_name,
            pot_bank_account_number,
            pot_bank_name,
            pot_bank_branch )
        VALUES (
            '$county',
      ...
      <div style="padding: 5px;">
        ...
        <div style="float: left; width: 49%;">
          ...
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
              ...
              <tr>
                <td>Email</td><td><input type="text" name="email" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Email 2</td><td><input type="text" name="email2" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Postal Address</td><td><input type="text" name="postal_address" class="input_textbox_p compact" /></td>
              </tr> 
              <tr>
                <td>Home County</td><td><input type="text" name="home_county" class="input_textbox_p compact" /></td>
              </tr> 
            </thead>
          </table >
          <br/>
          <h3 class="compact">Additional Contact Details</h3>
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead>
              <tr>
                <td> Contact Name</td><td><input type="text" name="additional_contact_name" class="input_textbox_p compact" value="" /></td>
              </tr>
              <tr>
                <td> Contact Phone </td><td><input type="text" placeholder="254" name="additional_contact_phone" id="additional_contact_phone" class="input_textbox_p compact" value="" onKeyUp="isNumeric(this.id);"/><span id="additional_contact_phoneSpan"></span></td>
              </tr>
              <tr>
                <td> Contact Phone 2</td><td><input type="text" placeholder="254" name="additional_contact_phone2" id="additional_contact_phone2" class="input_textbox_p compact" value="" onKeyUp="isNumeric(this.id);"/><span id="additional_contact_phone2Span"></span></td>
              </tr>
              <tr>
                <td> Contact Email</td><td><input type="text" name="additional_contact_email" class="input_textbox_p compact" value=""/></td>
              </tr>
            </thead>
          </table>
        </div>
        ...
        <div style="float: right; width: 49%">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead> 
              <tr>
                <td>Bank Account Name</td><td><input type="text" name="bank_account_name" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Account Number</td><td><input type="text" name="bank_account_number" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Name</td><td><input type="text" name="bank_name" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Branch</td><td><input type="text" name="bank_branch" class="input_textbox_p compact" /></td>
              </tr> 
            </thead>
          </table >
          <br/>
          <h3 class="compact">Potential Bank Details</h3>
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead> 
              <tr>
                <td>Bank Account Name</td><td><input type="text" name="pot_bank_account_name" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Account Number</td><td><input type="text" name="pot_bank_account_number" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Name</td><td><input type="text" name="pot_bank_name" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Branch</td><td><input type="text" name="pot_bank_branch" class="input_textbox_p compact" /></td>
              </tr>
            </thead>
          </table >
          <br/>
  ...
  <div>
    ...
    if (isset($_POST['editDetails'])) {
      ...
      while ($row = mysql_fetch_array($result_st)) {
        ...
        $additional_contact_name = $row['additional_contact_name'];
        $additional_contact_phone = $row['additional_contact_phone'];
        $additional_contact_phone2 = $row['additional_contact_phone2'];
        $additional_contact_email = $row['additional_contact_email'];
        $bank_account_name = $row['bank_account_name'];
        $bank_account_number = $row['bank_account_number'];
        $bank_name = $row['bank_name'];
        $bank_branch = $row['bank_branch'];
        $pot_bank_account_name = $row['pot_bank_account_name'];
        $pot_bank_account_number = $row['pot_bank_account_number'];
        $pot_bank_name = $row['pot_bank_name'];
        $pot_bank_branch = $row['pot_bank_branch'];
      }
    }
    if (isset($_POST['submitEditCC'])) {
      ...
      $query = ( "UPDATE county_contacts SET
          ...
          additional_contact_phone2 = '$additional_contact_phone2',
          additional_contact_email = '$additional_contact_email',
          bank_account_name = '$bank_account_name',
          bank_account_number = '$bank_account_number',
          bank_name = '$bank_name',
          bank_branch = '$bank_branch',
          pot_bank_account_name = '$pot_bank_account_name',
          pot_bank_account_number = '$pot_bank_account_number',
          pot_bank_name = '$pot_bank_name',
          pot_bank_branch = '$pot_bank_branch'   WHERE id='$id' " );
      ...
      <div style="padding: 5px;">
        ...
        <div style="float: left; width: 49%;">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead>
              <tr>
                <td> Contact Name</td><td><input type="text" name="additional_contact_name" class="input_textbox_p compact"  value="<?php echo $additional_contact_name; ?>"/></td>
              </tr>
              <tr>
                <td> Contact Phone </td><td><input type="text" name="additional_contact_phone" class="input_textbox_p compact"  value="<?php echo $additional_contact_phone; ?>"/></td>
              </tr>
              <tr>
                <td> Contact Phone 2</td><td><input type="text" name="additional_contact_phone2" class="input_textbox_p compact"  value="<?php echo $additional_contact_phone2; ?>"/></td>
              </tr>
              <tr>
                <td> Contact Email</td><td><input type="text" name="additional_contact_email" class="input_textbox_p compact"  value="<?php echo $additional_contact_email; ?>"/></td>
              </tr>
            </thead>
          </table>
        </div>
        ...
        <div style="float: right; width: 49%">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <thead> 
              <tr>
                <td>Bank Account Name</td><td><input type="text" name="pot_bank_account_name"  value="<?php echo $pot_bank_account_name; ?>"class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Account Number</td><td><input type="text" name="pot_bank_account_number"  value="<?php echo $pot_bank_account_number; ?>" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Name</td><td><input type="text" name="pot_bank_name"  value="<?php echo $pot_bank_name; ?>" class="input_textbox_p compact" /></td>
              </tr>
              <tr>
                <td>Bank Branch</td><td><input type="text" name="pot_bank_branch"  value="<?php echo $pot_bank_branch; ?>" class="input_textbox_p compact" /></td>
              </tr>
            </thead>
          </table >
          <input type="hidden" name="id" value="<?php echo $id; ?>" />
          ...
          <center>
            <div>
                   <?php if ($priv_county_contacts >= 3) { ?>
              <input type="submit" class="btn-custom" name="submitEditCC"  value="Edit Contact Details"/>
                   <?php } ?>
            </div>
          </center> 
        </div>
    ...
    <div style="padding: 5px;">
      ...
      <div style="float: left; width: 49%;">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <thead>
            <tr>
              <td> Contact Name</td><td><input type="text" class="input_textbox_p compact"  value="<?php echo $additional_contact_name; ?>" readonly/></td>
            </tr>
            <tr>
              <td> Contact Phone </td><td><input type="text" class="input_textbox_p compact"  value="<?php echo $additional_contact_phone; ?>" readonly/></td>
            </tr>
            <tr>
              <td> Contact Phone 2</td><td><input type="text" class="input_textbox_p compact"  value="<?php echo $additional_contact_phone2; ?>" readonly /></td>
            </tr>
            <tr>
              <td> Contact Email</td><td><input type="text"   class="input_textbox_p compact"  value="<?php echo $additional_contact_email; ?>" readonly /></td>
            </tr>
          </thead>
        </table>
      </div>
      ...
      <div style="float: right; width: 49%">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <thead> 
            <tr>
              <td>Bank Account Name</td><td><input type="text"  value="<?php echo $pot_bank_account_name; ?>"class="input_textbox_p compact"  readonly /></td>
            </tr>
            <tr>
              <td>Bank Account Number</td><td><input type="text" value="<?php echo $pot_bank_account_number; ?>" class="input_textbox_p compact"  readonly /></td>
            </tr>
            <tr>
              <td>Bank Name</td><td><input type="text"  value="<?php echo $pot_bank_name; ?>" class="input_textbox_p compact"  readonly /></td>
            </tr>
            <tr>
              <td>Bank Branch</td><td><input type="text"   value="<?php echo $pot_bank_branch; ?>" class="input_textbox_p compact" readonly  /></td>
            </tr>
          </thead>
        </table >
        <br/>
