  ...
  <body>
    ...
    <div class="contentMain">
      <div align="center" style="min-height:220px; width: 500px; padding: 30px; margin: 30px auto; font-family: TStar-Bol">
        ...
        <hr/>
        <form id="loginForm" name="loginForm" method="post" action="login-check_2.php">
          <br/>
          ...
          <tr>
             ...
             <td align="center" height="50px" > <a href="index.php" style="text-decoration: none; color: black">Staff Login</a>  </td>
            </tr>
              <tr>
