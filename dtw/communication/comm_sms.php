...
<html xmlns="http://www.w3.org/1999/xhtml" dir="ltr" lang="en-US" xml:lang="en">
    ...
    <body>
        ...
        if (isset($_POST['submitSendSMS'])) {
            ...
            if (strpos($recipient_number, ',') !== false) {
                $recipient_number = explode(',', $recipient_number);
                foreach ($recipient_number as $key => $value) {
                    $sms->sendSMS($recipient_number[$key], $sms_body);
                }
            } else {
                ...
                <div class="tabbable" >
                    ...
                    <div class="tab-content">
                        <div class="tab-pane <?php if ($tabActive == 'tab1') echo 'active'; ?>" id="tab1">
                            ...
                            <form method="POST">
                                <table border="0" cellpadding="0" cellspacing="0" width="80%"  >
                                    <thead>
                                        <tr>
                                            <td align="right">Sender : </td><td><input style="width:344px" type="text" name="sender" class="input_textbox_p " value="<?php echo $_SESSION['staff_name']; ?>" readonly required/></td>
                                        </tr>

                                        <tr>
                                            <?php if (!isset($_POST['make_selection']) || ($_POST['make_selection1'] ) || ($_POST['make_selection2'] )
                                                    || ($_POST['make_selection3'] ) || ($_POST['make_selection4'] ) || ($_POST['make_selection5'] )){ ?>
                                                <td align="right">Recipient Number : </td>
                                                <td>
                                                    <input  style="width:135px"type="text" name="recipient_number" id="recipient_number"  class="input_textbox_p " value="254" onkeyup="isNumeric(this.id);" /><span id="recipient_numberSpan"/>                   
                                                </td>
                                            <?php } ?>
                                            <tr>
                                                <td align="right"><a href="#openModalContactSelect" >Or Select Recipient Numbers</a></td>
                                                <td class="" style="width:70%"><div style="max-height:200px; overflow:auto">
                                                    <?php
                                                    if (isset($_POST['make_selection']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        foreach ($_POST['check_num'] as $value) {
                                                            $sql_cont = "SELECT * FROM health_contacts WHERE dmoh_phone = $value ORDER BY county ASC";
                                                            $result_cont = mysql_query($sql_cont);

                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td width="15%">' . $rows['county'] . '</td><td>  -  ' . $rows['district'] . ' </td><td>  -  ' . $rows['dmoh_name'] . ' </td><td width="22%">  -   ' . $rows['dmoh_phone'] . "</td></tr>";
                                                            }
                                                        ...
                                                        echo "</table>";
                                                        echo '<input type="hidden" name="recipient_number" value="' . $multi_numbers . '" />';
                                                    }
                                                            
                                                            if (isset($_POST['make_selection1']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        foreach ($_POST['check_num'] as $value) {
                                                            ...
                                                            $sql_cont = "SELECT * FROM education_contacts WHERE $value=deo_phone ORDER BY county ASC";
                                                            $result_cont = mysql_query($sql_cont);
                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td>' . $rows['county'] . '</td><td>  -  ' . $rows['district'] . '</td><td>  -  ' . $rows['deo_name'] . '</td><td>  -  ' . $rows['deo_phone'] . "</td></tr>";
                                                            }
                                                        ...
                                                        echo '<input type="hidden" name="recipient_number" value="' . $multi_numbers . '" />';
                                                            ...
                                                            if (isset($_POST['make_selection2']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        echo "<table>";
                                                        foreach ($_POST['check_num'] as $value) {
                                                            $sql_cont = "SELECT * FROM master_trainers WHERE $value=phone_number ORDER BY ministry ASC";
                                                            $result_cont = mysql_query($sql_cont);

                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td>' . $rows['ministry'] . '</td><td>  -  ' . $rows['posting_station'] . ' </td><td>  -  ' . $rows['full_name'] . ' </td><td>  -   ' . $rows['phone_number'] . "</td></tr>";
                                                            }
                                                        ...
                                                        echo '<input type="hidden" name="recipient_number" value="' . $multi_numbers . '" />';
                                                            ...
                                                            if (isset($_POST['make_selection3']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        foreach ($_POST['check_num'] as $value) {
                                                            ...
                                                            $sql_cont = "SELECT * FROM county_contacts WHERE $value=phone ORDER BY county ASC";
                                                            $result_cont = mysql_query($sql_cont);
                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td>' . $rows['county'] . '</td><td>  -  ' . $rows['title'] . '</td><td>  -  ' . $rows['full_name'] . '</td><td>  -  ' . $rows['phone'] . "</td></tr>";
                                                            }
                                                        ...
                                                        echo '<input type="hidden" name="recipient_number" value="' . $multi_numbers . '" />';
                                                            ...
                                                            if (isset($_POST['make_selection4']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        echo "<table>";
                                                        foreach ($_POST['check_num'] as $value) {
                                                            $sql_cont = "SELECT * FROM headteachers WHERE $value=phone ORDER BY county ASC";
                                                            $result_cont = mysql_query($sql_cont);

                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td>' . $rows['county'] . '</td><td>  -  ' . $rows['district'] . ' </td><td>  -  ' . $rows['name'] . ' </td><td>  -   ' . $rows['phone'] . "</td></tr>";
                                                            }
                                                        ...
                                                        echo '<input type="hidden" name="recipient_number" value="' . $multi_numbers . '" />';
                                                            ...
                                                            if (isset($_POST['make_selection5']) && $_POST['check_num'] != 0) {
                                                        ...
                                                        foreach ($_POST['check_num'] as $value) {
                                                            ...
                                                            $sql_cont = "SELECT * FROM staff WHERE $value = staff_mobile ORDER BY staff_town ASC";
                                                            $result_cont = mysql_query($sql_cont);
                                                            while ($rows = mysql_fetch_array($result_cont)) {
                                                                echo '<tr><td>' . $rows['staff_town'] . '</td><td>  -  ' . $rows['staff_role'] . ' </td><td>  -  ' . $rows['staff_name'] . ' </td><td>  -   ' . $rows['staff_mobile'] . "</td></tr>";
                                                            }
                                        ...
                                        <tr>
                                            <td align="right">Current Date</td><td><input style="width:100px" type="text"  class="input_textbox_p " value="<?php echo date('Y-m-d'); ?>" readonly/></td>
                                        </tr>

                                        <tr>
                                            <td align="right">Select SMS template:</td>
                                            <td>
                                                <select style="width:320px" name="sms_template" id="sms_template"  class="input_select_p" onchange="loadSubject(), loadBody();">
                                                ...
                                                <a style=" display:inline;text-decoration: none" target = 'blank' href="edit_smsTemp.php">
                                                    <img src="../images/icons/mainEdit.png" style="vertical-align: middle" height="30px"/></a>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="right">Subject : </td><td><input style="width:344px" type="text" name="subject" id="subject"  class="input_textbox_p " /><span id="subjectSpan"/></td>
                                        </tr>
                                        <tr>
                                            <td align="right">SMS body</td>
                                            <td><textarea style="width:344px" name="sms_body" id="sms_body"  class="input_textbox_p " rows="5" cols="50"  required>This is to remind you that we will have a teacher training session on Saturday 13th June starting from 10am.</textarea></td>
                                        </tr>
                                        <tr>  
                                            <td></td>
                                            <td><input type="submit" name="submitSendSMS" value="Send SMS" class="btn-custom"/></td>
                        ...
                        <div class="tab-pane <?php if ($tabActive == 'tab2') echo 'active'; ?>" id="tab2">
                            ...
                            <table style="width:100%; overflow-x: visible; overflow-y: scroll; float: left;" width="100%" border="1" frame="box" align="center" cellspacing="1" class="table-hover"  role="grid">
                                <thead>
...
<div id="openModalContactSelect" class="modalDialog">
    <div style="width:800px;">
        ...
        <div class="dashboard_menu" >
            <a class="btn btn-primary"  href="comm_sms.php#openModalContactSelect" style="text-decoration: none;">Health Contacts</a>
            <a class="btn btn-primary" href="comm_sms.php#openModalContactSelect1" style="text-decoration: none;">Education Contacts</a>
            <a class="btn btn-primary" href="comm_sms.php#openModalContactSelect2" style="text-decoration: none;">Master Trainers</a>
            <a class="btn btn-primary" href="comm_sms.php#openModalContactSelect3" style="text-decoration: none;">County Contacts</a>
            <a class="btn btn-primary" href="comm_sms.php#openModalContactSelect4" style="text-decoration: none;">Head Teachers</a>
            <a class="btn btn-primary" href="comm_sms.php#openModalContactSelect5" style="text-decoration: none;">Staff</a>
        </div></br>
        ...
        if (isset($_POST['search_table'])) {
            ...
            $searchQuery = "SELECT * FROM health_contacts WHERE dmoh_phone != '' AND county LIKE '%$county%'
            ...
            $result_set = mysql_query("SELECT * FROM health_contacts WHERE dmoh_phone != '' order by county  asc");
        }
        ?>
        <form action="#">
        ...
        <form method="post" action='comm_sms.php#close'>
...
<div id="openModalContactSelect1" class="modalDialog">
    <div style="width:800px;">
        ...
        if (isset($_POST['search_table'])) {
            ...
            $searchQuery = "SELECT * FROM education_contacts WHERE deo_phone != '' AND county LIKE '%$county1%'
            AND district LIKE '%$district_name%'
            ...
            $result_set = mysql_query("SELECT * FROM education_contacts WHERE deo_phone != '' order by county  asc");
        }
        ?>
        <form action="#">
            <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
        ...
        <form method="post" action='comm_sms.php#close'>
            ...
            <p align="center">
                ...
                <input type="submit" name="make_selection1" id="make_selection" value="Confirm Selection" class="btn-custom-pink"/> 
            </p>
...
<div id="openModalContactSelect2" class="modalDialog">
    <div style="width:800px;">
        ...
        if (isset($_POST['search_table'])) {
            ...
            $email = $_POST['email'];
            $searchQuery = "SELECT * FROM master_trainers WHERE phone_number != '' AND full_name LIKE '%$full_name%'
            ...
            $result_set = mysql_query("SELECT * FROM master_trainers WHERE phone_number != '' order by full_name asc");
        }
        ?>
        <form action="#">
            <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
        ...
        <div style=" margin-right: 20px">
            <form method="post">
                    ...
                    <thead>
                        ...
                        <form method="post" action='comm_sms.php#close'>
                            ...
                            <p align="center">
                                ...
                                <input type="submit" name="make_selection2" id="make_selection" value="Confirm Selection" class="btn-custom-pink"/> 
                            </p>
                        ...
                        <div id="openModalContactSelect3" class="modalDialog">
                            <div style="width:800px;">
                                ...
                                if (isset($_POST['search_table'])) {
                                    ...
                                    $searchQuery = "SELECT * FROM county_contacts WHERE phone != '' AND county LIKE '%$county2%'
              ...
              AND email  LIKE '%$emailSearch%' order by county asc ";
                                    ...
                                    $result_set = mysql_query("SELECT * FROM county_contacts WHERE phone != '' order by county  asc");
                                }
                                ?>
                                <form action="#">
                                    <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
                                ...
                                <form method="post" action='comm_sms.php#close'>
                                    ...
                                    <p align="center">
                                        ...
                                        <input type="submit" name="make_selection3" id="make_selection" value="Confirm Selection" class="btn-custom-pink"/> 
                                    </p>
                        ...
                        <div id="openModalContactSelect4" class="modalDialog">
                            <div style="width:800px;">
                                ...
                                if (isset($_POST['search_table'])) {
                                    ...
                                    $phone = $_POST['phone'];
                                    $email1 = $_POST['email'];
                                    $searchQuery = "SELECT * FROM headteachers WHERE phone != '' AND county LIKE '%$county%'
            ...
            AND email LIKE '%$email1%' order by county,district asc ";
                                    ...
                                    $result_set = mysql_query("SELECT * FROM headteachers WHERE phone != '' order by county  asc LIMIT 200");
                                }
                                ?>
                                <form action="#">
                                    <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
                                ...
                                <form method="post" action='comm_sms.php#close'>
                                    ...
                                    <p align="center">
                                        ...
                                        <input type="submit" name="make_selection4" id="make_selection" value="Confirm Selection" class="btn-custom-pink"/> 
                                    </p>
                        ...
                        <div id="openModalContactSelect5" class="modalDialog">
                            <div style="width:800px;">
                                ...
                                if (isset($_POST['search_table'])) {
                                    ...
                                    $searchQuery = "SELECT * FROM staff WHERE staff_mobile != '' AND staff_town LIKE '%$staff_town%'
            ...
            AND staff_email LIKE '%$staff_email%' order by staff_town asc ";
                                    ...
                                    $result_set = mysql_query("SELECT * FROM staff WHERE staff_mobile != '' order by staff_town  asc");
                                }
                                ?>
                                <form action="#">
                                    <input type="text" name="search" value="" id="id_search" placeholder="Filter records here" autofocus />
                                ...
                                <form method="post" action='comm_sms.php#close'>
                                    ...
                                    <p align="center">
                                        ...
                                        <input type="submit" name="make_selection5" id="make_selection" value="Confirm Selection" class="btn-custom-pink"/> 
                                    </p>
                        ...
                        <script>
                                                        ...
                                                        function loadSubject() {
                                                            var id = document.getElementById("sms_template").value;
                                                            ...
                                                            xmlhttp.open("GET", "ajax_files/load_comm_template.php?commType=sms&req=subject&id=" + id, true);
                                                            xmlhttp.send();
                                                        }
                                                        ...
                                                        function loadBody() {
                                                            ...
                                                            xmlhttp1.onreadystatechange = function() {
                                                                if (xmlhttp1.readyState == 4 && xmlhttp1.status == 200) {
                                                                    document.getElementById("sms_body").value = xmlhttp1.responseText;
                                                                }
                                                            }
                                                            // load the assumption to be used
                                                            xmlhttp1.open("GET", "ajax_files/load_comm_template.php?commType=sms&req=body&id=" + id, true);
                                                            xmlhttp1.send();
