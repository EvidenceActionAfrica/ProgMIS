  ...
  <body>
    ...
    <div class="contentMain">
      ...
      <div class="contentBody">
        ...
        <h1 style="text-align: center; margin-top: 0px">Communication</h1>
        <center>
          <div class="dashboardMenu1">
            <!-- SMS -->
            <a href="comm_sms.php"><div class="menuTile" style="background-color: #8E6105; width: 42%; border-radius: 10px;" onMouseOut="this.style.backgroundColor = '#9E6B06'" onMouseOver="this.style.backgroundColor = '#9E6B06'">
                <br/> SMS Communication <br/>  
                <img align="middle" src="../images/sms.png" height="100px"/>
              </div> </a>
            <!-- Email -->
            <a href="comm_emails.php"><div class="menuTile" style="background-color: #2E6889; width: 42%; border-radius: 10px;" onMouseOut="this.style.backgroundColor = '#2E6889'" onMouseOver="this.style.backgroundColor = '#24526B'">
