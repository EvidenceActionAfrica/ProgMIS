...
$html = ' 
  <table style="width: 100%">
    <tr>
      ...
      <td align="center" width="80%">
        ...
        <b style="font-size: 15px; ">(Programme Activities)</b><br/>
      </td>
  ...
  <table style="width: 100%; font-size: 11px">
    <tr>
      ...
      <td><b>WARD NAME : </b><font style="font-size: 14px">' . $division . '</font></td>
      <td><b>WARD ID: </b><font style="font-size: 14px">' . $division_id . '</font></td>
    </tr>
  </table>
  <br/>
</div>
...
<table border="1"  cellpadding="5" style="width: 100%; border: 2px solid black; font-size: 11px">
  <tr style="font-size: 9px">
    ...
    <td rowspan="2" align="center" style="width: 6%"><b>Total Enrolment <br/></b></td>
  </tr>
  <tr style="font-size: 9px">
...
<tr><td colspan="8" align="left" style="border: 1px solid black"><b style="font-size: 11px;">1. WARD Summary: Please add up all Form P sheet totals to give a summary for this Ward</b></td></tr>
  <tr style="font-size: 9px">
    ...
    <th rowspan="2" style="width: 10%; border: 1px solid black;"><br/><br/>Total Enrolment (A+B+C)</th>
  </tr>
  <tr style="font-size: 9px">
    <th style="border: 1px solid black"><br/><br/>Primary(A)</th>
    <th style="border: 1px solid black"><br/><br/>ECD(attached) (B)</th>
  </tr>
...
<table align="left" style="border: 2px solid black; font-size: 11px; width: 100%;">
  <tr><td colspan="3" style="border-bottom: 1px solid black"><b style="font-size: 12px">4. As a Sub-County please agree on and record the following dates:</b></td></tr>
  <tr>
    <th style="border: 1px solid black; width: 40%"><br/><br/><b>Event</b></th>
    <th style="border: 1px solid black; width: 40%"><b>Guidance on Date</b><br/>(As agreed by County)</th>
  ...
  <tr style="height: 30px">
    <th align="left" style="border: 1px solid black"><b>Return Form S to AEO</b></th>
    <th style="border: 1px solid black">About 1 week after deworming day</th>
    <th style="border: 1px solid black"><b style="font-size: 14px">_____/_____/ 18</b></th>
  </tr>
  <tr style="height: 30px">
    <th align="left" style="border: 1px solid black"><b>AEO Returns Form S and A to DEO</b></th>
    <th style="border: 1px solid black">About 2 weeks after deworming day</th>
    <th style="border: 1px solid black"><b style="font-size: 14px">_____/_____/ 18</b></th>
  </tr>
  <tr style="height: 30px">
    <th align="left" style="border: 1px solid black"><b>DEO returns S,A, and D to national team</b></th>
