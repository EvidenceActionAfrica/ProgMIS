...
class MYPDF extends TCPDF {
    ...
    //  <img  src=\"../../images/logo.png\"/>
        ...
        $this->Image($image_file, 10, 10, 15, '', 'PNG', '', 'T', false, 30, '', false, false, 0, false, false, false);
        // Set font
        $this->SetFont('helvetica', 'B', 20);
        // Title
        $this->Cell(0, 15, "Vendor Request Quotation", 0, false, 'C', 0, '', 0, false, 'M', 'M');
    }
...
/*
$pdf->SetXY(80, 20);
$pdf->Image('../../images/logo.png', '', '', 30, 30, '', '', '', false, 300, '', false, false, 1, false, false, false);
$data.=" <br/><br/><br/><br/>";
*/
