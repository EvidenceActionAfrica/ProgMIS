...
$categoryDelete=$_GET["deleteCategoryId"];
    $sql="DELETE from issues_categories WHERE id=".$categoryDelete;
   
  mysql_query($sql);
    $messageToUser = "Category Deleted Successfully!";
    
}
if(isset($_POST["submitcategory"])){
    $newCategory=isset($_POST["newCategory"])?mysql_real_escape_string($_POST["newCategory"]):"";
    
    $sql="INSERT INTO `issues_categories`(`category_name`) VALUES ('$newCategory')";
    mysql_query($sql)or die(mysql_error());
    $messageToUser = "A Category Was Added Successfully!";
               ...
               <center> <table border="0" cellpadding="0" cellspacing="0" width="100%">
                  <thead>
                    <tr>
                      ...
                      <td align="right">Raised By : </td><td><input type="text" name="raisedby" class="input_textbox" value="<?php echo $_SESSION['staff_name']; ?>" readonly/></td>
                    </tr>
                    <tr>
                      ...
                      <td align="right">Current Date : </td><td><input type="text"  class="input_textbox" value="<?php echo date('Y-m-d'); ?>" readonly/></td>
                    </tr>
                    <tr>
                      ...
                      <td align="right" >Status : </td><td><input type="text"  class="input_textbox" value="Raised" readonly/></td>
					  

                    </tr>
                     <td align="right" width>To be handled by:</td>
                      <td class="" width="10%" class="input_textbox">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <?php
                          $sql = "SELECT * FROM issues_categories  ORDER BY id ASC";
                          $result = mysql_query($sql);
                          while ($rows = mysql_fetch_array($result)) { //loop table rows
                            ?>
                          ...
                          <a target='_blank' href="#editCategory" style="width:20px"><img src='../images/icons/mainEdit.png' height='20px'/></a>
                      </td>
                    </tr>
                    <tr>
                      <td align="right">Subject: </td><td colspan="2"><input type="text" name="subject" id="subject"  class="input_textbox " required /></td>
                    </tr>
                    <tr>
                      <td align="right">Description</td>
                      <td ><textarea name="description" class=" " rows="5" cols="50" required>Description of the issue.</textarea></td>
                    </tr>
                    <tr>
                      <td></td>
                      <td align="right"><input type="submit" name="submitSaveIssue" value="Save Issue" class="btn-custom"/></td>
                    </tr>
                  </thead>
                </table></center>
...
<div id="openModal" class="modalDialog">
  <div style="width:500px;">
    ...
    <a href="#close" class="btn btn-danger" style="margin-left:100%;margin-top:-6%;" >X</a>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="70%"  >
        <thead><input type="hidden" name="id" value="<?php echo $id; ?>"/>
          ...
          <tr>
            ...
            <td><textarea name="sms_body" class="input_textbox_p " rows="2" cols="25"  required>This is to remind you that we will have a teacher training session on Saturday 13th June starting from 10am.</textarea></td>
          </tr>
          <tr>
            <td></td>
    ...
    <div class="tab-pane <?php if ($tabActive == 'tab1') echo 'active'; ?>" id="tab1">
      ...
      <form method="POST">
        <table border="0" cellpadding="0" cellspacing="0" width="80%"  >
          <thead>
            <tr>
              <td align="right">Sender : </td><td><input type="text" name="sender" class="input_textbox" value="<?php echo $_SESSION['staff_name']; ?>" readonly required/></td>
            </tr>
            <tr>
              <td align="right">Recipient Name : </td><td><input type="text" name="recipient_name" id="recipient_name"  class="input_textbox" required /></td>
            </tr>
            <tr>
              <td align="right">Recipient Email address : </td><td><input type="text" name="recipient_email" id="recipient_email"  class="input_textbox"  onkeyup="isEmail(this.id);" required/><span id="recipient_emailSpan"/></td>
            </tr>
            <tr>
              <td align="right">Current Date</td><td><input type="text"  class="input_textbox" value="<?php echo date('Y-m-d'); ?>" readonly/></td>
            </tr>
            <tr>
              <td align="right">Subject : </td><td><input type="text" name="subject" id="subject"  class="input_textbox" /><span id="subjectSpan"/></td>
            </tr>
            <tr>
              <td align="right" >Select Email template:</td>
              <td>
                <select name="sms_template"  class="input_select ">
                  <option value=''<?php if ($district == '') echo 'selected'; ?> >None: User will write</option>
                  <?php
                  $sql = "SELECT * FROM comm_sms_template  ORDER BY title ASC";
                  $result = mysql_query($sql);
            ...
            <tr>
              ...
              <td><textarea name="email_body" class="input_textbox" rows="4" cols="25" required>This is to remind you that we will have a teacher training session on Saturday 13th June starting from 10am.</textarea></td>
            </tr>
            <tr>
              <td></td>
              <td align="right"><input type="submit" name="submitSendEmail" value="Send Email" class="btn-custom"/></td>
            </tr>
          </thead>
        </table>
        <div class="vclear"></div>
...
<div id="openModalAddAction" class="modalDialog">
  <div style="width:800px;">
    ...
    <a href="#close" class="btn btn-danger" style="margin-left:100%;margin-top:-4%;" >X</a>
      ...
      <table border="0" cellpadding="0" cellspacing="0" width="95%"  >
        <thead>
          ...
          <tr>
            ...
            <td  colspan="2"><textarea name="response" class="input_textbox " rows="2" cols="15" required>Description of action from respondent</textarea></td>
          </tr>
            <tr>
          ...
          <tr>
            <td></td>
            <td align="right"><input type="submit" name="submitSaveAction" value="Save Action" class="btn-custom"/></td>
          </tr>
        </thead>
      </table>
      <div class="vclear"></div>
...
<div id="openModalActions" class="modalDialog">
  <div style="width:700px;">
    <a href="#close" class="btn btn-danger" style="margin-left:100%;margin-top:-4.5%;" >X</a>
    <?php
     $issueId = $_POST['id'];
    ?>
...
<div id="editCategory" class="modalDialog">
  <div style="width:800px;">
    ...
    <table>
                <?php
                $sql="SELECT * FROM issues_categories";
                $result=mysql_query($sql);
               
                echo "<tr>";
                echo "<th>Id</th><th colspan='2'>Category Name</th><th></th><th>Delete</th>";
                echo "</tr><tr>";
                $id=1;
                while($row=mysql_fetch_array($result)){
                    echo "<tr>";
                    echo "<td>".$id."</td><td align='center' colspan='2'>".$row["category_name"]."</td><td><a href='javascript:void(0)' onclick='show_confirm2(". $row["id"].")'><img src='../images/icons/delete.png' height='20px'></a><td>";
                    echo "</tr>"; 
                    ++$id;
                }
    ...
    <tr>
        ...
        <td><input type='submit' name='submitcategory' value='Add Category'/></td>
...
<script>
    ...
    function show_confirm(deleteid) {
     ...
     function show_confirm2(deleteid) {
      if (confirm("Are you sure you want to delete?")) {
        location.replace('?deleteCategoryId=' + deleteid);
      } else {
        return false;
      }
    }
