  ...
  <body>
    ...
    <div class="contentMain">
      ...
      <div class="contentBody" >
        ...
        <center>
          <b style="font-size: 20px">Add Issue </b>
        </center>
        ...
        <form method="POST">
          <table border="0" cellpadding="0" cellspacing="0" width="80%"  >
            <thead>
              ...
              <tr>
                <td align="right">Subject: </td><td colspan="2">
                  <input type="text" name="subject" id="subject" class="input_textbox_p"  style="width: 50%"required />
                </td>
              </tr>
              <tr>
                <td align="right">Description</td>
                <td colspan="2"><textarea name="description" class="input_textbox_p " rows="3" cols="15" style="width: 50%"required>Description of the issue.</textarea></td>
              </tr>
              <tr>
                <td></td>
