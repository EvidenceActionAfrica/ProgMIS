...
<table id="data-table" class="table table-responsive table-hover table-stripped">
         ...
         <thead>
                <tr>
                  ...
                  <th align="Left" >Number of <br/> Wards</th>
    ...
    <center>
      <div style="padding: 5px; margin: 0px auto">
        <table border="0">
          ...
          <tr>
            <td>Number Of Wards</td><td><input type="text" class="input_textbox" value="<?php echo $numberOfDivisions; ?>" readonly style="width: 50px; text-align: center"/></td>
          </tr>
          <tr>
