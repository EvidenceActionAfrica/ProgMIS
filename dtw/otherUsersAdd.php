    ...
    <div class="contentMain">
      ...
      <div class="contentBody">
        ...
        <div id="middle_section">
          <center>
            <h2 style="text-align: center">Authorised Non-Staff</h2>
            ...
            <div style="float:left; width: 60%;">
              ...
              if (isset($_POST['Submit'])) {
                ...
                $query = "INSERT INTO other_users (image,staff_name,staff_role,staff_gender,staff_mobile,staff_email,staff_password) 
              ...
              // echo $query;
                ...
                if (!$result) {
                  ...
                  echo "<div style='text-align:center;width:auto;margin:0 auto;padding:5px;border:1px solid #3eda00;border-radius:10px; margin:5px;background-color:#a2ff7e;'>
                        <font align='justify' size='3px'><br/> New Non-Staff added successfully </font>
                        <br/><br/>
                      </div><br/>
                      <center><a href='otherUsers.php' class='btn-custom'> Return to Other Users list</a></center>
