          ...
          <form method="post">
            ...
            <tbody>
              ...
              while ($row = mysql_fetch_array($result_set)) {
                ...
                if($priv_steering>=3){
                $link = "steering.php?id=$id&editDetails=1#editHealth";
			}else{
...
<?php
$sql = "SELECT timestamp from `steering_committee` order by timestamp desc limit 1";
        ...
        <div style="">
          ...
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
             ...
             <tr>
                <td> Contact Phone </td><td><input type="text" name="mobile" id="mobile" class="input_textbox" placeholder="254" onKeyUp="isNumeric(this.id);"/><span id="mobileSpan"></span></td>
              </tr>
                <tr>
                <td> Contact Email </td><td><input type="email" name="email" class="input_textbox" /></td>
              </tr>
                  <tr>
        ...
        <div style="">
          ...
          <table border="0"  cellpadding="0" cellspacing="0" width="100%">
            <thead>
             ...
             <tr>
                <td> Contact Phone </td><td><input type="text" name="mobile" id="mobile" class="input_textbox" placeholder="254" value="<?php echo $mobile; ?>" onKeyUp="isNumeric(this.id);"/><span id="mobileSpan"></span></td>
              </tr>
                <tr>
                <td> Contact Email </td><td><input type="email" name="email" class="input_textbox" value="<?php echo $email; ?>" /></td>
              </tr>
                  <tr>
          ...
          <br/>
            ...
            <table> <tr>
                <td><input type="submit" class="btn-custom" name="submitEditMember"  value="update Member Details"/></td>
                <td><a href="#close" class="btn-custom" >Close</a></td>
              </tr> </table>
          </center>
        </div>
...
<div id="importCSV" class="modalDialog">
  <div style="width:380px">
    <a href="#close" title="Close" class="close">X</a>
    <div >
      <h1 class="form-title">Upload Steering committee</h1><br/>
    </div>
<?php
            ...
            <thead>
              <tr>
                ...
                <td>
                  ...
                  $insertformdata = $evidenceaction->mysql_fetch_all($tablename, $fields, $where);
                  ?>
                  <select id="ministry" name="ministry" class="input_select" required  disabled>
                    <option value="">Choose Ministry</option>
                    <option value="<?php echo $ministry; ?>" selected="selected"><?php echo $ministry; ?></option>
             ...
             <tr>
                <td> Contact Phone </td><td><input type="text" name="mobile" id="mobile" class="input_textbox" placeholder="254" value="<?php echo $mobile; ?>" onKeyUp="isNumeric(this.id);" disabled/><span id="mobileSpan"></span></td>
              </tr>
                <tr>
                <td> Contact Email </td><td><input type="email" name="email" class="input_textbox" value="<?php echo $email; ?>" disabled/></td>
              </tr>
                  <tr>
