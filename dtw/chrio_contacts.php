    ...
    <div class="contentMain">
      ...
      <div class="contentBody">
        ...
        if (isset($_GET['deleteid'])) {
          ...
          $query = "DELETE FROM chrio_contacts WHERE id='$deleteid'";
        ...
        if (isset($_POST['search_table'])) {
          $county = $_POST['county'];
          $chrio_name = $_POST['chrio_name'];
          $chrio_phone = $_POST['chrio_phone'];
          $chrio_email = $_POST['chrio_email'];
          $searchQuery = "SELECT * FROM chrio_contacts WHERE county LIKE '%$county%'
              AND names LIKE '%$chrioh_name%'
              AND telephone_no LIKE '%$chrio_phone%'
              AND email LIKE '%$chrio_email%' order by county ASC ";
          $result_set = mysql_query($searchQuery);
        } else {
          $result_set = mysql_query("SELECT * FROM chrio_contacts order by county ASC");
        }
        ?>
        ...
        <form action="#">
          ...
          <?php } ?><b style="margin-left:20%;width: 100px; font-size:1.5em;">CHRIO Contacts</b>
          <?php if ($priv_pharmacist >= 1) { ?>
            <a class="btn-custom-small" href="PHPExcel/AdminData/CHRIO.php?county=<?php echo $county; ?>&chrio_name=<?php echo $chrio_name; ?>&chrio_phone=<?php echo $chrio_phone; ?>&chrio_email=<?php echo $chrio_email; ?>">Export to Excel</a>
          <?php } if ($priv_pharmacist >= 2) { ?>
            <a class="btn-custom-small" href="#addCHRIOContact">Add CHRIO Contact</a>
          <?php } ?>
        </form>
        <br/>
        <style>
            ...
            <table  width="99.3%">
              <thead >
                <tr style="">
                  ...
                  <th align="center" width="23%"><input type="text" style="width: 98%" name="chrio_name"  value="<?php echo $chrio_name ?>"/></th>
                  <th align="center" width="17%"><input type="text" style="width: 98%" name="chrio_phone"  value="<?php echo $chrio_phone ?>"/></th>
                  <th align="center" width="28%"><input type="text" style="width: 98%" name="chrio_email"  value="<?php echo $chrio_email ?>"/></th>
            ...
            <table id="data-table" class="table table-responsive table-hover table-stripped">
              ...
              <tbody>
                ...
                while ($row = mysql_fetch_array($result_set)) {
                  $id = $row['id'];
                  $county = $row['county'];
                  $chrio_name = $row['names'];
                  $chrio_phone = $row['telephone_no'];
                  $chrio_email = $row['email'];
                  if ($priv_pharmacist >= 3) {
                    $link = "chrio_contacts.php?id=$id&editDetails=1#editPharmacist";
                  } else if ($priv_pharmacist >= 1) {
                    $link = "chrio_contacts.php?id=$id&viewDetails=1#viewMoH";
                  } else {
                    $link = "chrio_contacts.php#";
                  }
                  ?> 
                  <tr style="border-bottom: 1px solid #B4B5B0;">
                    <td align="left" width="17%"> <?php echo "<a href=$link>" . $county . "</a>"; ?> </td> 
                    <td align="left" width="23%"> <?php echo "<a href=$link>" . $chrio_name . "</a>"; ?> </td>
                    <td align="left" width="17%"><?php
                      echo "<a href=$link>" . substr($chrio_phone, 0, 12);
                      if (strlen($chrio_phone) > 12)
                        echo "..";
                      echo "</a>";
                      ?>
                    </td>
                    <td align="left" width="36%"><?php
                      echo "<a href=$link>" . substr($chrio_email, 0, 30);
                      if (strlen($chrio_email) > 30)
                        echo "..";
                      echo "</a>";
                      ?>
                    </td> 
...
<!--==== Modal ADD ======-->
<div id="addCHRIOContact" class="modalDialog">
  <div style="width:30%">
    <a href="#close" title="Close" class="close">X</a>
    <?php
    $formSubmitted = false;
    if (isset($_POST['submitAddCHRIO'])) {
      ...
      $chrio_name = addslashes(trim($chrio_name));
      $chrio_phone = addslashes(trim($chrio_phone));
      $chrio_email = addslashes(trim($chrio_email));



      $query = ( "INSERT INTO chrio_contacts (county,names,telephone_no,email)
        VALUES (
            '$county','$chrio_name','$chrio_phone','$chrio_email')" );
      ...
      $staff_email = $_SESSION['staff_email'];
      $staff_name = $_SESSION['staff_name'];
      $action = "Added \"CHRIO Contact\" ";
      $description = "Record ID: " . $chrio_name . " added";
      $arrLogAdminData = array($staff_id, $staff_email, $staff_name, $action, $description);
      funclogAdminData($arrLogAdminData);
    }
    ?>
    <form action="" method="post" >
      ...
      <h1 class="form-title">Add CHRIO Contact</h1>
        ...
        <div style="">
          ...
          <table border="0"  cellpadding="0" cellspacing="0" style="width:100%">
            <thead>
              ...
              <tr>
                <td>Names</td><td><input style="width:90%" type="text" name="chrio_name" class="input_textbox_p compact" value="" required/></td>
              </tr>
              <tr>
                <td>Phone</td><td><input style="width:90%" type="text" name="chrio_phone" id="chrio_phone" class="input_textbox_p compact" maxlength="12" placeholder="254" onKeyUp="isPhoneNumber(this.id);" required/><span id="chrio_phoneSpan"></span></td>
              </tr>
              <tr>
                <td>Email</td><td><input style="width:90%" type="text" name="chrio_email" class="input_textbox_p compact" /></td>
              </tr>
            </thead>
          </table >
          <br/>
          <center>
            <table> <tr>
                <td><input type="submit" class="btn-custom-small" name="submitAddCHRIO"  value="Add CHRIO Contact"/></td>
              </tr> </table>
          </center>
        </div>    
      </div>
...
<!--==== Modal EDIT ======-->
<div id="editCHRIO" class="modalDialog">
  <div style="width:30%">
    <a href="#close" title="Close" class="close">X</a>
    <?php
    if (isset($_GET['editDetails'])) {
      $id = $_GET['id'];
      $result_st = mysql_query("SELECT * FROM chrio_contacts WHERE id='$id'");
    ...
    if (isset($_POST['submitEditCHRIO'])) {
      $id = $_POST['id'];
      $county = $_POST['county'];
      $chrio_name = $_POST['chrio_name'];
      $chrio_phone = $_POST['chrio_phone'];
      ...
      $query = ( "UPDATE chrio_contacts SET
          county ='$county',
          names ='$chrio_name',
          telephone_no ='$chrio_phone',
          email ='$chrio_email' WHERE id='$id' " );
      mysql_query($query) or die(mysql_error("Could not enter"));
      ...
      $staff_email = $_SESSION['staff_email'];
      $staff_name = $_SESSION['staff_name'];
      $action = "Edited \"CHRIO Contact\" ";
      $description = "Record ID: " . $chrio_name . " Edited";
      $arrLogAdminData = array($staff_id, $staff_email, $staff_name, $action, $description);
      funclogAdminData($arrLogAdminData);
    }
    ?>
    <form action="" method="post">
      <?php include("includes/messageBox.php"); ?>
      <h1 class="form-title">Edit CHRIO Contact Details</h1>
        ...
        <div >
          ...
          <table border="0"  cellpadding="0" cellspacing="0" style="width:100%">
            <thead>
              ...
              <tr>
                <td>Name</td><td><input type="text" style="width:90%" name="chrio_name" class="input_textbox_p compact"value="<?php echo $chrio_name; ?>" required/></td>
              </tr>
              <tr>
                <td>Phone</td><td><input type="text" style="width:90%" name="chrio_phone" class="input_textbox_p compact" maxlength="12"value="<?php echo $chrio_phone; ?>" required/></td>
              </tr>              
              <tr>
                <td>Email</td><td><input type="text" style="width:90%" name="chrio_email" class="input_textbox_p compact" value="<?php echo $chrio_email; ?>"/></td>
              </tr>              
            </thead>
          </table >
          <br/>
          <center>
            <div>
              <input type="submit" class="btn-custom" name="submitEditMoH"  value="Edit CHRIO Details"/>
            </div>
          </center>
        </div>        
...
<div id="importCSV" class="modalDialog">
  <div style="width:380px">
    <a href="#close" title="Close" class="close">X</a>
    <div >
      <h1 class="form-title">Upload CHRIO contacts </h1><br/>
    </div>
    <?php
    if (isset($csvMessage)) {
...
<!--===== Modal View ===========================-->
<div id="viewCHRIO" class="modalDialog">
  <div style="width:30%">
    <a href="#close" title="Close" class="close">X</a>
    <h1 class="form-title">View CHRIO Contact Details</h1>
    <?php
      ...
      <div style="float: left; width: 49%;">
        ...
        <table border="0"  cellpadding="0" cellspacing="0" style="width:100%">
          <thead>
            ...
            <tr>
              <td>Name</td><td><input type="text" style="width:90%" name="chrio_name" class="input_textbox_p compact" value="<?php echo $chrio_name; ?>" readonly/></td>
            </tr>
            <tr>
              <td>Phone</td><td><input type="text" style="width:90%" name="chrio_phone" class="input_textbox_p compact"  value="<?php echo $chrio_phone; ?>" readonly/></td>
            </tr>
            <tr>
              <td>Email</td><td><input type="email" style="width:90%" name="chrio_email" class="input_textbox_p compact" value="<?php echo $chrio_email; ?>" readonly/></td>
            </tr>
          </thead>
        </table >
      </div>      
