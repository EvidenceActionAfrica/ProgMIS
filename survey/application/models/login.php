    ...
    public function getByID($email) {
        ...
        foreach ($rows as $key => $row) {
            $data[] = array(
                ...
                //Maurice Added Code
                'priv_survey_tracker_kenya' => $row['priv_survey_tracker_kenya'],
                'priv_survey_tracker_malawi' => $row['priv_survey_tracker_malawi'],
                'priv_survey_tracker_uganda' => $row['priv_survey_tracker_uganda']
            );
        }
