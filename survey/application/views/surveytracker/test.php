                    ...
                    <div class="row">
                        ...
                        <?php                        
                                foreach ($fields as $key => $value) {
                                    if($value['Key'] == 'PRI'){
                                      ...
                                      echo '
                                        ...
                                        echo '
                                            <div class="form-group">
                                                <label>' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                                <input type="text" id="' . $value['Field'] . '" name="' . $value['Field'] . '" class="form-control input-sm datepicker" onKeyUp="isNumeric(this.id);"/><span id="' . $value['Field'] . 'Span"></span>
                                                        </div>
                                                ';
                                        ...
                                        echo '
                                                ...
                                                <!-- //<input type="text" name="' . $value['Field'] . '" class="form-control input-sm datepicker" value="'.$activeDate.'" /> -->
                                                    <input type="date"  name="' . $value['Field'] . '" class="form-control input-sm datepicker" data-date-format="MM/DD/YYYY" value="'.$activeDate.'" />
                                                </div>
                                            ';
                                        ...
                                        echo '
                                                <div class="form-group">
                                                    <label> ' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <!-- //<input type="text" name="' . $value['Field'] . '" class="form-control input-sm datepicker" data-date-format="MM/DD/YYYY" /> -->
                                                    <input type="date"  name="' . $value['Field'] . '" class="form-control input-sm datepicker"  data-date-format="MM/DD/YYYY" />
                                                </div>
                                            ';
                                        ...
                                        if (strpos($value['Field'], 'date_tobe_resolved') !== false && strpos($value['Field'], 'remarks') == 'unresolved') {
                                            echo '
                                                <div class="form-group">
                                                    <label> ' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <!-- //<input type="text" name="' . $value['Field'] . '" class="form-control input-sm datepicker"  /> -->
                                                    <input type="date" name="' . $value['Field'] . '" class="form-control input-sm datepicker"  />
                                                </div>
                                            ';
                                        }
                                    ...
                                    //Maurice added code for new date for resolution for date_tobe_resolved
                                    else if (strpos($value['Field'], 'date_tobe_resolved') !== false&& isset($activeDate)) {
                                        echo '
                                                <div class="form-group">
                                                    <label> ' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <!-- //<input type="text" name="' . $value['Field'] . '" class="form-control input-sm datepicker"  /> -->
                                                    <input type="date" name="' . $value['Field'] . '" class="form-control input-sm"  />
                                                </div>
                                            ';
                                    }
                                        ...
                                        echo '
                                                <div class="form-group">
                                                    <label> ' . ucwords(str_replace('_', ' ', $value['Field'])) . '</label><br>
                                                    <!-- //<input type="text" name="' . $value['Field'] . '" class="form-control input-sm datepicker"  /> -->
                                                    <input type="date" id="newdatepicker" name="' . $value['Field'] . '" class="form-control input-sm"  />
                                                </div>
                                            ';
                                    }
