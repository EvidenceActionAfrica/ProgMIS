            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        <li class="nav-item">
                            <a href="<?php echo URL; ?>surveytracker/tracker"  aria-expanded="false" class="nav-link dropdown-toggle"> <span class="mini-dn">Surveys</span> <span class="indicator-right-menu mini-dn"></span></a>
                        ...
                        <li class="nav-item">
                            ...
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                ...
                                <a href="<?php echo URL; ?>surveytracker/catDSW" class="dropdown-item">DSW</a>
                                <a href="<?php echo URL; ?>surveytracker/catDTW" class="dropdown-item">DTW</a>
                                <a href="<?php echo URL; ?>surveytracker/catBeta" class="dropdown-item">BETA</a>
                                <a href="<?php echo URL; ?>surveytracker/catOther" class="dropdown-item">UNCLASSIFIED</a>
                            </div>
                        </li>
                        <li class="nav-item">
                            <a href="<?php echo URL; ?>surveytracker/trash"  aria-expanded="false" class="nav-link dropdown-toggle">Trash Bin</a>
                                        ...
                                        <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true"  data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true" data-cookie-id-table="saveId" data-show-export="true" data-click-to-select="true" data-toolbar="#toolbar">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th data-field="name" >Survey Name</th>
                                                    <th data-field="email">Survey Type</th>
                                                    <th data-field="phone">Survey Category</th>
                                                    <th data-field="">Sub-Category</th>
                                                    <th data-field="company">Owner</th>
                                                    <th data-field="date">Upload Date</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                   ...
                                                   <td ><a href="<?php echo URL?>surveytracker/download/<?php echo $dd['filename'];?>"><button>Download</button></td>
                                                    ...
                                                    <td ><a href="<?php echo URL?>surveytracker/restore/<?php echo $dd['id'];?>"><button>Restore</button></td>
                                                    <td ><a href="<?php echo URL?>surveytracker/remove_trash/<?php echo $dd['id'];?>"><button>Delete</button></td>
                                                    <?php } ?>
