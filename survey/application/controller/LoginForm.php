			...
			if (isset($_POST['email']) && isset($_POST['password']) && isset($_POST['country'])) {
				...
				if ($validate != 0) {
					...
					*/
					...
					//Maurice Added Code
					$_SESSION["priv_survey_tracker_kenya"] = $data[0]['priv_survey_tracker_kenya'];
					$_SESSION["priv_survey_tracker_malawi"] = $data[0]['priv_survey_tracker_malawi'];
					$_SESSION["priv_survey_tracker_uganda"] = $data[0]['priv_survey_tracker_uganda'];
