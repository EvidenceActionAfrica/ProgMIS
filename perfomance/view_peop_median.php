        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered table-striped table-hover" style="width: 50%; float: left;"> 
                <tr>
                  ...
                  <th width="39%" Style = "width:30%">No of dispenser (Target)</th>
                    ...
                    <table class="table table-bordered table-striped table-hover" style="width: 50%; float: left;">
                        <tr  style="cursor:pointer; ">
                          ...
                          <th width="43%" Style = "width:30%"><?php
                                $query_tot_ken = "SELECT avg_users FROM dsw_per_verification WHERE avg_users !='' AND country=$country_val_";
                        ...
                        while ($row = mysqli_fetch_assoc($res1_ken)) {
                            ...
                            <tr> <?php $prog = $row["program"]; ?>
                              ...
                              <td width="34%" Style = "width:30%"><?php
                                    $query_ken = "SELECT avg_users FROM dsw_per_verification WHERE program = '$prog' AND avg_users !=''";
                              ...
                              <td width="36%" Style = "width:30%"><?php
                                    $query1_ken = "SELECT avg_users AS num FROM dsw_per_verification WHERE program = '$prog' ORDER BY avg_users";
                                    ...
                                    if ($deno_ken == 0) {
										...
										$mid = (count($deno_ken)/2);
                                        $ans_ken = ($mid % 2 !=0)? $deno_ken{$mid-1}: (($deno_ken{$mid-1}) + $deno_ken[$mid])/2;
                                        echo $ans_ken;
                                    }
                                    ?></td> 
                      </tr> 
