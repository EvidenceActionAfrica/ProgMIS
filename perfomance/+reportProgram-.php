				...
				<div class="divBody">
					...
					<div id="divPrntPage">
						...
						<table border="1" style="width:100%; font-family: TSTAR Mono Round; font-size: 1.1em; font-weight: bold;">
							...
							<tr>
								<td style="background-color: #EF637D;">Number of Chlorine dispensers installed</td>
								<td>
									<?php
								...
								<td style="background-color: #EF637D;">Total number of Chlorine deliveries made</td>
								<td>
									<?php
							...
							<tr>
								...
								<td style="background-color: #EF637D;">
									<?php
										$query_ken = "SELECT avg_users FROM dsw_per_verification WHERE program = '" . $glbAdpProg . "' AND avg_users !=''";
										$result_ken = mysqli_query($mysqli, $query_ken) or die(mysqli_query($mysqli));
										$deno_ken = mysqli_affected_rows($mysqli);
										
										$query1_ken = "SELECT SUM(avg_users) AS num FROM dsw_per_verification WHERE program = '" . $glbAdpProg . "'";
										...
										$query_ken = "SELECT c302b_hhold_ppl  FROM dsw_per_adoption_rates WHERE program = '" . $glbAdpProg . "' AND c302b_hhold_ppl !=''";
										$result_ken = mysqli_query($mysqli, $query_ken) or die(mysqli_query($mysqli));
										$deno2_ken = mysqli_affected_rows($mysqli);
										$query1_ken = "SELECT SUM(c302b_hhold_ppl ) AS num FROM dsw_per_adoption_rates WHERE program = '" . $glbAdpProg . "'";
										$result1_ken = mysqli_query($mysqli, $query1_ken) or die(mysqli_query($mysqli));
										$row_num_ken = mysqli_fetch_assoc($result1_ken);
							...
							<tr>
								<td style="background-color: #EF637D;">Percentage of dispensers that are operational during unannounced visits</td>
								<td>
								<?php
								...
								<td style="background-color: #EF637D;">Average 30 day Chlorine usage</td>
								<td>
									<?php
							...
							<tr>
								<td style="background-color: #EF637D;">Percentage Total Chlorine residue (TCR)</td>
								<td>
									<?php
										$sumprod_a_n = 0;
										$nume_weit_sum = 0;
								...
								<td style="background-color: #EF637D;">Average diarrhea rate in the past 2 weeks</td>
								<td>
									<?php
										$sumprod_a_n = 0;
										$nume_weit_sum = 0;
							...
							<tr>
								<td style="background-color: #EF637D;">Average CEM attendance</td>
								<td>
									<?php
								...
								<td style="background-color: #EF637D;">Average VCS attendance</td>
								<td>
									<?php
