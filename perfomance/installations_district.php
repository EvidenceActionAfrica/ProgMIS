...
<form id="logform1"  method="$_POST" style='float: left'>  
  ...
  <input class="btn btn-primary" type="submit" name="submit_view" id="submit_view" value="PER DISTRICT">
  ...
  <table class="table table-bordered table-striped table-hover">
              ...
              <table width="10%" class="table table-bordered table-striped table-hover" id="districttable" style="width: 100%; float: left;">
                ...
                <?php
                    $prog_sum = 0;
                    $av_div_prog = 0;
                    $res = mysqli_query($mysqli, "SELECT distinct district FROM `dispenser_database` WHERE country='$country_val' ORDER BY district");
                ...
                <tr>
                  ...
                  <td><?php
                                ...
                                $query = "SELECT * FROM dispenser_database WHERE district = '$district' AND country='$country_val' and              							`year` like '2010'";
                  ...
                  <td><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district = '$district' AND country='$country_val' and              							`year` like '2011'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                  ...
                  <td><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district = '$district' AND country='$country_val' and              							`year` like '2012'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                  ...
                  <td><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and              							`year` like '2013'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                  ...
                  <td><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and            							`year` like '2014'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                  ...
                  <td><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and            							`year` like '2015'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                  ...
                  <th><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and              							( month > 0 AND month < 4) and `year` like '2016'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                   ...
                   <th><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and              							( month > 3 AND month < 7 ) and `year` like '2016'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                   ...
                   <th><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and              							( month > 6 AND month < 10 ) and `year` like '2016'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
                   ...
                   <th><?php
                                $field = 'cem301_attendees_total';
                                $query = "SELECT * FROM dispenser_database WHERE district like '$district' AND country='$country_val' and              							( month > 9 AND month < 13 ) and `year` like '2016'";
                                $result = mysqli_query($mysqli, $query) or die(mysqli_query($mysqli));
